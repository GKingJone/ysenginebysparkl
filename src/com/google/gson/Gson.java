...
/* 126 */       return (T)Gson.this.fromJson(json, typeOfT);
/*     */     }
/*     */   };
/*     */   
...
/*     */     }
/*     */     
/* 135 */     public JsonElement serialize(Object src, Type typeOfSrc) { return Gson.this.toJsonTree(src, typeOfSrc); }
/*     */   };
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/* 192 */     List<TypeAdapterFactory> factories = new ArrayList();
/*     */     
/*     */ 
...
/*     */       }
/*     */       
/* 259 */       public void write(JsonWriter out, Number value) throws IOException { if (value == null) {
/* 260 */           out.nullValue();
/* 261 */           return;
/*     */         }
...
/*     */       }
/*     */       
/* 283 */       public void write(JsonWriter out, Number value) throws IOException { if (value == null) {
/* 284 */           out.nullValue();
/* 285 */           return;
/*     */         }
...
/*     */       }
/*     */       
/* 315 */       public void write(JsonWriter out, Number value) throws IOException { if (value == null) {
/* 316 */           out.nullValue();
/* 317 */           return;
/*     */         }
...
/*     */     }
/*     */     
/* 337 */     Map<TypeToken<?>, FutureTypeAdapter<?>> threadCalls = (Map)this.calls.get();
...
/*     */     
/*     */ 
/* 346 */     FutureTypeAdapter<T> ongoingCall = (FutureTypeAdapter)threadCalls.get(type);
/* 347 */     if (ongoingCall != null) {
/* 348 */       return ongoingCall;
/*     */     }
/*     */     try
/*     */     {
/* 352 */       FutureTypeAdapter<T> call = new FutureTypeAdapter();
...
/* 690 */     return (T)Primitives.wrap(classOfT).cast(object);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 743 */     return (T)Primitives.wrap(classOfT).cast(object);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 842 */     return (T)Primitives.wrap(classOfT).cast(object);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */       }
/* 885 */       return (T)this.delegate.read(in);
/*     */     }
/*     */     
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\gson\Gson.class
