...
/*  39 */     for (Map.Entry<String, JsonElement> entry : this.members.entrySet()) {
/*  40 */       result.add((String)entry.getKey(), ((JsonElement)entry.getValue()).deepCopy());
/*     */     }
/*  42 */     return result;
/*     */   }
/*     */   
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\gson\JsonObject.class
