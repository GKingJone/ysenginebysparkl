...
/*     */   };
/*     */   
/* 537 */   public static final TypeAdapter<Calendar> CALENDAR = new TypeAdapter()
/*     */   {
...
/* 701 */         out.beginObject();
/* 702 */         for (Entry<String, JsonElement> e : value.getAsJsonObject().entrySet()) {
...
/*     */       try {
/* 723 */         for (T constant : (Enum[])classOfT.getEnumConstants()) {
...
/*     */         }
/* 762 */         return new EnumTypeAdapter(rawType);
/*     */       }
/*     */     };
/*     */   }
/*     */   
...
/*     */   {
/* 779 */     new TypeAdapterFactory()
/*     */     {
/*     */       public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
/* 782 */         return typeToken.getRawType() == this.val$type ? typeAdapter : null;
/*     */       }
/*     */       
/* 785 */       public String toString() { return "Factory[type=" + this.val$type.getName() + ",adapter=" + typeAdapter + "]"; }
/*     */     };
/*     */   }
/*     */   
/*     */ 
...
/*     */       }
/*     */       
/* 799 */       public String toString() { return "Factory[type=" + boxed.getName() + "+" + this.val$unboxed.getName() + ",adapter=" + typeAdapter + "]"; }
/*     */     };
/*     */   }
/*     */   
/*     */ 
...
/*     */       }
/*     */       
/* 814 */       public String toString() { return "Factory[type=" + this.val$base.getName() + "+" + sub.getName() + ",adapter=" + typeAdapter + "]"; }
/*     */     };
/*     */   }
/*     */   
/*     */ 
...
/*     */   {
/* 822 */     new TypeAdapterFactory()
/*     */     {
/*     */       public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
/* 825 */         return this.val$clazz.isAssignableFrom(typeToken.getRawType()) ? typeAdapter : null;
/*     */       }
/*     */       
/* 828 */       public String toString() { return "Factory[typeHierarchy=" + this.val$clazz.getName() + ",adapter=" + typeAdapter + "]"; }
/*     */     };
/*     */   }
/*     */ }


/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\gson\internal\bind\TypeAdapters.class
