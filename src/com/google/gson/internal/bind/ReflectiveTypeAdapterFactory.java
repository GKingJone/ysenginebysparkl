...
/*     */     
/*     */ 
/*  81 */     new BoundField(name, serialize, deserialize) {
...
/* 102 */     Map<String, BoundField> result = new LinkedHashMap();
...
/*     */     
/* 152 */     private Adapter(ObjectConstructor<T> constructor, Map<String, BoundField> boundFields) { this.constructor = constructor;
...
/*     */       }
/*     */       
/* 162 */       T instance = this.constructor.construct();
/*     */       try
/*     */       {
/* 165 */         in.beginObject();
/* 166 */         while (in.hasNext()) {
/* 167 */           String name = in.nextName();
/* 168 */           BoundField field = (BoundField)this.boundFields.get(name);
...
/* 190 */       out.beginObject();
/*     */       try {
/* 192 */         for (BoundField boundField : this.boundFields.values()) {
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\gson\internal\bind\ReflectiveTypeAdapterFactory.class
