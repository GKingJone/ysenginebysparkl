...
/*      */ 
/*      */ 
/*  238 */   private final char[] buffer = new char['Ѐ'];
...
/*      */   
/*  272 */   public JsonReader(Reader in) { this.stack[(this.stackSize++)] = 6;
/*      */     
/*      */ 
/*      */ 
/*      */ 
...
/*      */     } else {
/*  467 */       if ((peekStack == 3) || (peekStack == 5)) {
...
/*      */     
/*  599 */     if ((c == 't') || (c == 'T')) {
/*  600 */       String keyword = "true";
/*  601 */       String keywordUpper = "TRUE";
/*  602 */       peeking = 5; } else { int peeking;
/*  603 */       if ((c == 'f') || (c == 'F')) {
/*  604 */         String keyword = "false";
/*  605 */         String keywordUpper = "FALSE";
/*  606 */         peeking = 6; } else { int peeking;
/*  607 */         if ((c == 'n') || (c == 'N')) {
/*  608 */           String keyword = "null";
/*  609 */           String keywordUpper = "NULL";
/*  610 */           peeking = 7;
/*      */         } else {
/*  612 */           return 0; } } }
/*      */     int peeking;
...
/*  712 */             return 0;
/*      */           }
/*  714 */           long newValue = value * 10L - (c - '0');
/*  715 */           fitsInLong &= ((value > -922337203685477580L) || ((value == -922337203685477580L) && (newValue < value)));
/*      */           
/*  717 */           value = newValue;
/*  718 */         } else if (last == 3) {
/*  719 */           last = 4;
/*  720 */         } else if ((last == 5) || (last == 6)) {
/*  721 */           last = 7;
/*      */         }
/*      */         break;
/*      */       }
/*      */     }
/*      */     label372:
/*  727 */     if ((last == 2) && (fitsInLong) && ((value != Long.MIN_VALUE) || (negative))) {
...
/*      */     String result;
/*  778 */     if (p == 14) {
/*  779 */       result = nextUnquotedValue(); } else { String result;
/*  780 */       if (p == 12) {
/*  781 */         result = nextQuotedValue('\''); } else { String result;
/*  782 */         if (p == 13) {
...
/*      */     String result;
/*  806 */     if (p == 10) {
/*  807 */       result = nextUnquotedValue(); } else { String result;
/*  808 */       if (p == 8) {
/*  809 */         result = nextQuotedValue('\''); } else { String result;
/*  810 */         if (p == 9) {
/*  811 */           result = nextQuotedValue('"');
/*  812 */         } else if (p == 11) {
/*  813 */           String result = this.peekedString;
/*  814 */           this.peekedString = null; } else { String result;
/*  815 */           if (p == 15) {
/*  816 */             result = Long.toString(this.peekedLong);
/*  817 */           } else if (p == 16) {
/*  818 */             String result = new String(this.buffer, this.pos, this.peekedNumberLength);
...
/*  894 */     } else if ((p == 8) || (p == 9)) {
/*  895 */       this.peekedString = nextQuotedValue(p == 8 ? '\'' : '"');
/*  896 */     } else if (p == 10) {
...
/*  938 */     } else if ((p == 8) || (p == 9)) {
/*  939 */       this.peekedString = nextQuotedValue(p == 8 ? '\'' : '"');
/*      */       try {
/*  941 */         long result = Long.parseLong(this.peekedString);
/*  942 */         this.peeked = 0;
/*  943 */         return result;
/*      */       }
...
/*      */         
/*      */       }
/* 1045 */       else if (i < this.buffer.length) {
...
/* 1164 */       this.peekedString = nextQuotedValue(p == 8 ? '\'' : '"');
/*      */       try {
/* 1166 */         result = Integer.parseInt(this.peekedString);
/* 1167 */         this.peeked = 0;
/* 1168 */         return result;
/*      */       }
/*      */       catch (NumberFormatException ignored) {}
...
/* 1179 */     int result = (int)asDouble;
/* 1180 */     if (result != asDouble) {
...
/*      */       
/*      */ 
/* 1267 */       if ((this.lineNumber == 0) && (this.lineStart == 0) && (this.limit > 0) && (buffer[0] == 65279)) {
/* 1268 */         this.pos += 1;
/* 1269 */         this.lineStart += 1;
/* 1270 */         minimum++;
/*      */       }
/*      */       
...
/* 1316 */       int c = buffer[(p++)];
/* 1317 */       if (c == 10) {
/* 1318 */         this.lineNumber += 1;
/* 1319 */         this.lineStart = p;
/*      */       }
/* 1321 */       else if ((c != 32) && (c != 13) && (c != 9))
/*      */       {
/*      */ 
/*      */ 
/* 1325 */         if (c == 47) {
...
/* 1398 */       if (c == '\n') {
/* 1399 */         this.lineNumber += 1;
/* 1400 */         this.lineStart = this.pos;
/*      */       } else {
/* 1402 */         if (c == '\r') {
/*      */           break;
/*      */         }
...
/*      */   {
/*      */     label104:
/* 1413 */     for (; (this.pos + toFind.length() <= this.limit) || (fillBuffer(toFind.length())); this.pos += 1)
/* 1414 */       if (this.buffer[this.pos] == '\n') {
/* 1415 */         this.lineNumber += 1;
...
/*      */       }
/*      */       
/* 1455 */       char result = '\000';
/* 1456 */       int i = this.pos; for (int end = i + 4; i < end; i++) {
/* 1457 */         char c = this.buffer[i];
/* 1458 */         result = (char)(result << '\004');
/* 1459 */         if ((c >= '0') && (c <= '9')) {
/* 1460 */           result = (char)(result + (c - '0'));
/* 1461 */         } else if ((c >= 'a') && (c <= 'f')) {
/* 1462 */           result = (char)(result + (c - 'a' + 10));
/* 1463 */         } else if ((c >= 'A') && (c <= 'F')) {
/* 1464 */           result = (char)(result + (c - 'A' + 10));
/*      */         } else {
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\gson\stream\JsonReader.class
