...
/*     */ {
/* 145 */   private static final String[] REPLACEMENT_CHARS = new String[''];
/* 146 */   static { for (int i = 0; i <= 31; i++) {
...
/* 156 */     HTML_SAFE_REPLACEMENT_CHARS = (String[])REPLACEMENT_CHARS.clone();
...
/*     */   
/* 170 */   public JsonWriter(Writer out) { push(6);
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */       String replacement;
/* 540 */       if (c < '') {
/* 541 */         String replacement = replacements[c];
/* 542 */         if (replacement == null)
/*     */           continue;
/*     */       } else { String replacement;
/* 545 */         if (c == ' ') {
/* 546 */           replacement = "\\u2028";
/* 547 */         } else { if (c != ' ') continue;
/* 548 */           replacement = "\\u2029";
/*     */         }
/*     */       }
/*     */       
...
/*     */     
/* 569 */     this.out.write("\n");
/* 570 */     int i = 1; for (int size = this.stackSize; i < size; i++) {
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\gson\stream\JsonWriter.class
