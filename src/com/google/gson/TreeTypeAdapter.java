...
/*  52 */       return (T)delegate().read(in);
/*     */     }
/*  54 */     JsonElement value = Streams.parse(in);
/*  55 */     if (value.isJsonNull()) {
/*  56 */       return null;
/*     */     }
/*  58 */     return (T)this.deserializer.deserialize(value, this.typeToken.getType(), this.gson.deserializationContext);
/*     */   }
/*     */   
...
/*  76 */     return d != null ? d : (this.delegate = this.gson.getDelegateAdapter(this.skipPast, this.typeToken));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\gson\TreeTypeAdapter.class
