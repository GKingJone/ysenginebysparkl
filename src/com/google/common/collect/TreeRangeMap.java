...
/*     */             }
/* 532 */             Cut<K> cutToStart = (Cut)Objects.firstNonNull(TreeRangeMap.this.entriesByLowerBound.floorKey(SubRangeMap.this.subRange.lowerBound), SubRangeMap.this.subRange.lowerBound);
/*     */             
/*     */ 
/* 535 */             final Iterator<RangeMapEntry<K, V>> backingItr = TreeRangeMap.this.entriesByLowerBound.tailMap(cutToStart, true).values().iterator();
/*     */             
...
/* 542 */                   RangeMapEntry<K, V> entry = (RangeMapEntry)backingItr.next();
/* 543 */                   if (entry.getLowerBound().compareTo(SubRangeMap.this.subRange.upperBound) >= 0)
/*     */                     break;
/* 545 */                   if (entry.getUpperBound().compareTo(SubRangeMap.this.subRange.lowerBound) > 0)
/*     */                   {
/* 547 */                     return Maps.immutableEntry(entry.getKey().intersection(SubRangeMap.this.subRange), entry.getValue());
/*     */                   }
/*     */                 }
/*     */                 
/* 551 */                 return (Entry)endOfData();
/*     */               }
/*     */             };
/*     */           }
/*     */           
/*     */           public boolean retainAll(Collection<?> c)
/*     */           {
/* 558 */             return SubRangeMapAsMap.this.removeEntryIf(Predicates.not(Predicates.in(c)));
/*     */           }
/*     */           
/*     */           public int size()
/*     */           {
...
/* 578 */             return SubRangeMapAsMap.this.removeEntryIf(Predicates.compose(Predicates.in(c), Maps.valueFunction()));
/*     */           }
/*     */           
/*     */           public boolean retainAll(Collection<?> c)
/*     */           {
/* 583 */             return SubRangeMapAsMap.this.removeEntryIf(Predicates.compose(Predicates.not(Predicates.in(c)), Maps.valueFunction()));
/*     */           }
/*     */         };
/*     */       }
/*     */     }
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\common\collect\TreeRangeMap.class
