...
/*      */     <K, V> MapMakerInternalMap.ReferenceEntry<K, V> copyEntry(Segment<K, V> segment, ReferenceEntry<K, V> original, ReferenceEntry<K, V> newNext)
/*      */     {
...
/*      */ 
/*      */ 
/* 1028 */     public void setExpirationTime(long time) { this.time = time; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1041 */     public void setNextExpirable(ReferenceEntry<K, V> next) { this.nextExpirable = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1076 */     public void setNextEvictable(ReferenceEntry<K, V> next) { this.nextEvictable = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1110 */     public void setExpirationTime(long time) { this.time = time; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1123 */     public void setNextExpirable(ReferenceEntry<K, V> next) { this.nextExpirable = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1151 */     public void setNextEvictable(ReferenceEntry<K, V> next) { this.nextEvictable = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1283 */     public void setExpirationTime(long time) { this.time = time; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1296 */     public void setNextExpirable(ReferenceEntry<K, V> next) { this.nextExpirable = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1332 */     public void setNextEvictable(ReferenceEntry<K, V> next) { this.nextEvictable = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1367 */     public void setExpirationTime(long time) { this.time = time; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1380 */     public void setNextExpirable(ReferenceEntry<K, V> next) { this.nextExpirable = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1408 */     public void setNextEvictable(ReferenceEntry<K, V> next) { this.nextEvictable = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1541 */     public void setExpirationTime(long time) { this.time = time; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1554 */     public void setNextExpirable(ReferenceEntry<K, V> next) { this.nextExpirable = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1590 */     public void setNextEvictable(ReferenceEntry<K, V> next) { this.nextEvictable = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1625 */     public void setExpirationTime(long time) { this.time = time; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1638 */     public void setNextExpirable(ReferenceEntry<K, V> next) { this.nextExpirable = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/*      */ 
/*      */ 
/* 1666 */     public void setNextEvictable(ReferenceEntry<K, V> next) { this.nextEvictable = next; }
/*      */     
/*      */     @GuardedBy("Segment.this")
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\common\collect\MapMakerInternalMap.class
