...
/*     */   {
/* 123 */     return (comparator instanceof Ordering) ? (Ordering)comparator : new ComparatorOrdering(comparator);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 135 */     return (Ordering)Preconditions.checkNotNull(ordering);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 161 */     return new ExplicitOrdering(valuesInOrder);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   
/*     */   @VisibleForTesting
/* 262 */   static class ArbitraryOrdering extends Ordering<Object> { private Map<Object, Integer> uids = Platform.tryWeakKeys(new MapMaker()).makeComputingMap(new Function()
/*     */     {
/*     */ 
/*     */ 
...
/*     */       
/*     */ 
/* 288 */       int result = ((Integer)this.uids.get(left)).compareTo((Integer)this.uids.get(right));
/* 289 */       if (result == 0) {
...
/*     */   {
/* 330 */     return new ReverseOrdering(this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 341 */     return new NullsFirstOrdering(this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 352 */     return new NullsLastOrdering(this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 366 */     return new ByFunctionOrdering(function, this);
/*     */   }
/*     */   
...
/*     */   {
/* 387 */     return new CompoundOrdering(this, (Comparator)Preconditions.checkNotNull(secondaryComparator));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 408 */     return new CompoundOrdering(comparators);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 437 */     return new LexicographicalOrdering(this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 479 */     return (E)min(iterable.iterator());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 555 */     return (E)max(iterable.iterator());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 613 */       Collection<E> collection = (Collection)iterable;
...
/*     */ 
/*     */ 
/* 620 */         E[] array = (Object[])collection.toArray();
...
/*     */     
/* 678 */     E[] buffer = (Object[])new Object[bufferCap];
...
/* 713 */             } else { if (pivotNewIndex >= k) break;
...
/*     */   {
/* 815 */     E[] array = (Object[])Iterables.toArray(iterable);
...
/*     */   {
/* 845 */     E[] elements = (Object[])Iterables.toArray(iterable);
/* 846 */     for (E e : elements) {
/* 847 */       Preconditions.checkNotNull(e);
/*     */     }
/* 849 */     Arrays.sort(elements, this);
/* 850 */     return ImmutableList.asImmutableList(elements);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\common\collect\Ordering.class
