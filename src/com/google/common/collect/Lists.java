...
/*  103 */     ArrayList<E> list = new ArrayList(capacity);
/*  104 */     Collections.addAll(list, elements);
/*  105 */     return list;
/*      */   }
/*      */   
/*      */   @VisibleForTesting
/*  109 */   static int computeArrayListCapacity(int arraySize) { CollectPreconditions.checkNonnegative(arraySize, "arraySize");
/*      */     
/*      */ 
...
/*  540 */       new TransformedListIterator(this.fromList.listIterator(index))
/*      */       {
/*      */         T transform(F from) {
/*  543 */           return (T)TransformingSequentialList.this.function.apply(from);
/*      */         }
/*      */       };
/*      */     }
/*      */   }
...
/*      */     
/*      */     public ListIterator<T> listIterator(int index) {
/*  579 */       new TransformedListIterator(this.fromList.listIterator(index))
/*      */       {
/*      */         T transform(F from) {
/*  582 */           return (T)TransformingRandomAccessList.this.function.apply(from);
/*      */         }
/*      */       };
/*      */     }
/*      */     
...
/*      */     
/*      */     public T remove(int index) {
/*  795 */       return (T)this.forwardList.remove(reverseIndex(index));
/*      */     }
/*      */     
...
/*  803 */       return (T)this.forwardList.set(reverseIndex(index), element);
/*      */     }
/*      */     
/*      */     public T get(int index) {
/*  807 */       return (T)this.forwardList.get(reverseIndex(index));
/*      */     }
/*      */     
/*      */     public int size() {
...
/*  854 */           return ReverseList.this.reversePosition(forwardIterator.nextIndex());
/*      */         }
/*      */         
/*      */         public T previous() {
/*  858 */           if (!hasPrevious()) {
...
/*      */     
/*      */     public E get(int index) {
/* 1011 */       return (E)this.backingList.get(index);
/*      */     }
/*      */     
/*      */     public E remove(int index) {
/* 1015 */       return (E)this.backingList.remove(index);
/*      */     }
/*      */     
/*      */     public E set(int index, E element) {
/* 1019 */       return (E)this.backingList.set(index, element);
/*      */     }
/*      */     
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\common\collect\Lists.class
