...
/* 901 */       if (cmp < 0)
/* 902 */         return this.left == null ? this : (AvlNode)Objects.firstNonNull(this.left.ceiling(comparator, e), this);
/* 903 */       if (cmp == 0) {
/* 904 */         return this;
/*     */       }
...
/* 912 */       if (cmp > 0)
/* 913 */         return this.right == null ? this : (AvlNode)Objects.firstNonNull(this.right.floor(comparator, e), this);
/* 914 */       if (cmp == 0) {
/* 915 */         return this;
/*     */       }
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\common\collect\TreeMultiset.class
