...
/* 107 */     this.funnel = ((Funnel)Preconditions.checkNotNull(funnel));
...
/*     */     try {
/* 290 */       return new BloomFilter(new BloomFilterStrategies.BitArray(numBits), numHashFunctions, funnel, BloomFilterStrategies.MURMUR128_MITZ_32);
/*     */     }
...
/*     */     }
/* 359 */     return (-n * Math.log(p) / (Math.log(2.0D) * Math.log(2.0D)));
/*     */   }
/*     */   
/*     */ 
/* 363 */   private Object writeReplace() { return new SerialForm(this); }
/*     */   
...
/*     */     }
/*     */     
/* 379 */     Object readResolve() { return new BloomFilter(new BloomFilterStrategies.BitArray(this.data), this.numHashFunctions, this.funnel, this.strategy, null); }
/*     */   }
/*     */   
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\common\hash\BloomFilter.class
