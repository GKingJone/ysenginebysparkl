...
/*     */   {
/* 465 */     long timeoutMicros = unit.toMicros(timeout);
...
/*     */     
/* 493 */     long waitMicros = storedPermitsToWaitTime(this.storedPermits, storedPermitsToSpend) + (freshPermits * this.stableIntervalMicros);
/*     */     
/*     */ 
...
/* 644 */         micros = (permitsAboveHalfToTake * (permitsToTime(availablePermitsAboveHalf) + permitsToTime(availablePermitsAboveHalf - permitsAboveHalfToTake)) / 2.0D);
/*     */         
/* 646 */         permitsToTake -= permitsAboveHalfToTake;
/*     */       }
/*     */       
/* 649 */       micros = (micros + this.stableIntervalMicros * permitsToTake);
/* 650 */       return micros;
/*     */     }
/*     */     
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\common\util\concurrent\RateLimiter.class
