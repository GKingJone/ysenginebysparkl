...
/* 128 */     MathPreconditions.checkInRange((z > -2.147483649E9D ? 1 : 0) & (z < 2.147483648E9D ? 1 : 0));
/* 129 */     return (int)z;
/*     */   }
/*     */   
/*     */ 
...
/* 151 */     MathPreconditions.checkInRange((-9.223372036854776E18D - z < 1.0D ? 1 : 0) & (z < 9.223372036854776E18D ? 1 : 0));
/* 152 */     return z;
/*     */   }
/*     */   
/*     */ 
...
/* 176 */       return BigInteger.valueOf(x);
/*     */     }
...
/* 241 */       break;
/*     */     case DOWN: 
/* 243 */       increment = (exponent < 0 ? 1 : 0) & (!isPowerOfTwo(x) ? 1 : 0);
/* 244 */       break;
/*     */     case UP: 
/* 246 */       increment = (exponent >= 0 ? 1 : 0) & (!isPowerOfTwo(x) ? 1 : 0);
/* 247 */       break;
/*     */     case HALF_EVEN: 
/*     */     case HALF_UP: 
/*     */     case HALF_DOWN: 
/* 251 */       double xScaled = DoubleUtils.scaleNormalize(x);
/*     */       
/*     */ 
/* 254 */       increment = xScaled * xScaled > 2.0D;
/* 255 */       break;
/*     */     default: 
/* 257 */       throw new AssertionError();
/*     */     }
/* 259 */     return increment ? exponent + 1 : exponent;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */   @VisibleForTesting
/* 302 */   static final double[] everySixteenthFactorial = { 1.0D, 2.0922789888E13D, 2.631308369336935E35D, 1.2413915592536073E61D, 1.2688693218588417E89D, 7.156945704626381E118D, 9.916779348709496E149D, 1.974506857221074E182D, 3.856204823625804E215D, 5.5502938327393044E249D, 4.7147236359920616E284D };
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/* 398 */     MeanAccumulator accumulator = new MeanAccumulator(null);
...
/*     */   {
/* 410 */     MeanAccumulator accumulator = new MeanAccumulator(null);
...
/*     */   {
/* 423 */     MeanAccumulator accumulator = new MeanAccumulator(null);
...
/*     */   {
/* 436 */     MeanAccumulator accumulator = new MeanAccumulator(null);
...
/*     */   {
/* 449 */     MeanAccumulator accumulator = new MeanAccumulator(null);
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\common\math\DoubleMath.class
