...
/* 346 */     Maps.transformValues(this.parameters.asMap(), new Function()
/*     */     {
...
/*     */   {
/* 363 */     ImmutableSet<String> charsetValues = ImmutableSet.copyOf(this.parameters.get("charset"));
/* 364 */     switch (charsetValues.size()) {
/*     */     case 0: 
/* 366 */       return Optional.absent();
/*     */     case 1: 
/* 368 */       return Optional.of(Charset.forName((String)Iterables.getOnlyElement(charsetValues)));
/*     */     }
...
/* 404 */     for (Entry<String, String> entry : this.parameters.entries()) {
...
/*     */   {
/* 462 */     return ((mediaTypeRange.type.equals("*")) || (mediaTypeRange.type.equals(this.type))) && ((mediaTypeRange.subtype.equals("*")) || (mediaTypeRange.subtype.equals(this.subtype))) && (this.parameters.entries().containsAll(mediaTypeRange.parameters.entries()));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 474 */     return create(type, subtype, ImmutableListMultimap.of());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 533 */       String attribute = normalizeToken((String)entry.getKey());
/* 534 */       builder.put(attribute, normalizeParameterValue(attribute, (String)entry.getValue()));
/*     */     }
...
/* 575 */               valueBuilder.append(tokenizer.consumeCharacter(CharMatcher.ASCII));
/*     */             } else {
/* 577 */               valueBuilder.append(tokenizer.consumeToken(QUOTED_TEXT_MATCHER));
/*     */             }
/*     */           }
/* 580 */           String value = valueBuilder.toString();
...
/* 667 */       builder.append("; ");
/* 668 */       Multimap<String, String> quotedParameters = Multimaps.transformValues(this.parameters, new Function()
/*     */       {
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\common\net\MediaType.class
