...
/*     */   {
/* 108 */     return (Double.NEGATIVE_INFINITY < value ? 1 : 0) & (value < Double.POSITIVE_INFINITY ? 1 : 0);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/* 394 */     public int compare(double[] left, double[] right) { int minLength = Math.min(left.length, right.length);
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\common\primitives\Doubles.class
