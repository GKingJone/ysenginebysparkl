...
/*     */   {
/* 104 */     return (Float.NEGATIVE_INFINITY < value ? 1 : 0) & (value < Float.POSITIVE_INFINITY ? 1 : 0);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/* 390 */     public int compare(float[] left, float[] right) { int minLength = Math.min(left.length, right.length);
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\common\primitives\Floats.class
