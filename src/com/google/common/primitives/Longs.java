...
/* 271 */       result[i] = ((byte)(int)(value & 0xFF));
/* 272 */       value >>= 8;
/*     */     }
/* 274 */     return result;
/*     */   }
...
/*     */   {
/* 306 */     return (b1 & 0xFF) << 56 | (b2 & 0xFF) << 48 | (b3 & 0xFF) << 40 | (b4 & 0xFF) << 32 | (b5 & 0xFF) << 24 | (b6 & 0xFF) << 16 | (b7 & 0xFF) << 8 | b8 & 0xFF;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/* 486 */     public int compare(long[] left, long[] right) { int minLength = Math.min(left.length, right.length);
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\google\common\primitives\Longs.class
