...
/*  81 */     if (result != value)
/*     */     {
/*  83 */       long l = value;throw new IllegalArgumentException(34 + "Out of range: " + l);
/*     */     }
/*  85 */     return result;
/*     */   }
/*     */   
...
/*     */   {
/* 292 */     return new byte[] { (byte)(value >> '\b'), (byte)value };
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/* 410 */     public int compare(char[] left, char[] right) { int minLength = Math.min(left.length, right.length);
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\primitives\Chars.class
