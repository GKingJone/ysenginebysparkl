...
/*     */   {
/* 107 */     return (Double.NEGATIVE_INFINITY < value ? 1 : 0) & (value < Double.POSITIVE_INFINITY ? 1 : 0);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/* 393 */     public int compare(double[] left, double[] right) { int minLength = Math.min(left.length, right.length);
...
/* 588 */   static final Pattern FLOATING_POINT_PATTERN = ;
/*     */   
/*     */   @GwtIncompatible("regular expressions")
...
/* 595 */     String str1 = String.valueOf(String.valueOf(hex));String completeHex = 25 + str1.length() + "0[xX]" + str1 + "[pP][+-]?\\d++[fFdD]?";
/* 596 */     String str2 = String.valueOf(String.valueOf(completeDec));String str3 = String.valueOf(String.valueOf(completeHex));String fpPattern = 23 + str2.length() + str3.length() + "[+-]?(?:NaN|Infinity|" + str2 + "|" + str3 + ")";
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\primitives\Doubles.class
