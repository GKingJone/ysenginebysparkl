...
/*  88 */     if (result != value)
/*     */     {
/*  90 */       long l = value;throw new IllegalArgumentException(34 + "Out of range: " + l);
/*     */     }
/*  92 */     return result;
/*     */   }
/*     */   
...
/*     */     
/* 453 */     public int compare(short[] left, short[] right) { int minLength = Math.min(left.length, right.length);
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\primitives\Shorts.class
