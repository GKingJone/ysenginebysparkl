...
/*     */     
/* 289 */     public int compare(boolean[] left, boolean[] right) { int minLength = Math.min(left.length, right.length);
...
/* 458 */       builder.append(this.array[this.start] != 0 ? "[true" : "[false");
/* 459 */       for (int i = this.start + 1; i < this.end; i++) {
/* 460 */         builder.append(this.array[i] != 0 ? ", true" : ", false");
/*     */       }
/* 462 */       return ']';
/*     */     }
/*     */     
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\primitives\Booleans.class
