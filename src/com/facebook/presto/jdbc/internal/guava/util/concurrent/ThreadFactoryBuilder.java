...
/*     */     
/* 155 */     ThreadFactory backingThreadFactory = builder.backingThreadFactory != null ? builder.backingThreadFactory : Executors.defaultThreadFactory();
/*     */     
/*     */ 
/*     */ 
/* 159 */     final AtomicLong count = nameFormat != null ? new AtomicLong(0L) : null;
/* 160 */     new ThreadFactory() {
/*     */       public Thread newThread(Runnable runnable) {
/* 162 */         Thread thread = this.val$backingThreadFactory.newThread(runnable);
/* 163 */         if (nameFormat != null) {
/* 164 */           thread.setName(String.format(nameFormat, new Object[] { Long.valueOf(count.getAndIncrement()) }));
/*     */         }
/* 166 */         if (daemon != null) {
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\util\concurrent\ThreadFactoryBuilder.class
