...
/*      */ import com.facebook.presto.jdbc.internal.guava.io.ByteArrayDataInput;
...
/*  243 */     if (skipIndex >= 0)
/*      */     {
/*  245 */       int partsHi = skipIndex;
/*  246 */       int partsLo = parts.length - skipIndex - 1;
/*  247 */       if (parts[0].length() == 0) { partsHi--; if (partsHi != 0)
/*  248 */           return null;
/*      */       }
/*  250 */       if (parts[(parts.length - 1)].length() == 0) { partsLo--; if (partsLo != 0) {
/*  251 */           return null;
/*      */         }
/*      */       }
/*      */     }
...
/*  295 */     String str1 = String.valueOf(String.valueOf(initialPart));String str2 = String.valueOf(String.valueOf(penultimate));String str3 = String.valueOf(String.valueOf(ultimate));return 1 + str1.length() + str2.length() + str3.length() + str1 + str2 + ":" + str3;
/*      */   }
/*      */   
...
/*  364 */       hextets[i] = Ints.fromBytes(0, 0, bytes[(2 * i)], bytes[(2 * i + 1)]);
/*      */     }
/*      */     
...
/*  464 */       String str = String.valueOf(String.valueOf(toAddrString(ip)));return 2 + str.length() + "[" + str + "]";
/*      */     }
...
/*  491 */       String ipString = hostAddr.substring(1, hostAddr.length() - 1);
/*  492 */       expectBytes = 16;
/*      */     } else {
...
/*      */     }
/*      */     
/*  988 */     Preconditions.checkArgument(i >= 0, "Decrementing %s would wrap.", new Object[] { address }); int 
/*      */     
/*  990 */       tmp55_54 = i; byte[] tmp55_53 = addr;tmp55_53[tmp55_54] = ((byte)(tmp55_53[tmp55_54] - 1));
...
/*      */     }
/*      */     
/* 1011 */     Preconditions.checkArgument(i >= 0, "Incrementing %s would wrap.", new Object[] { address }); int 
/*      */     
/* 1013 */       tmp56_55 = i; byte[] tmp56_54 = addr;tmp56_54[tmp56_55] = ((byte)(tmp56_54[tmp56_55] + 1));
