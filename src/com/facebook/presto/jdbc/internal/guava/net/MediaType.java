...
/* 386 */     Maps.transformValues(this.parameters.asMap(), new Function()
/*     */     {
...
/*     */   {
/* 403 */     ImmutableSet<String> charsetValues = ImmutableSet.copyOf(this.parameters.get("charset"));
/* 404 */     switch (charsetValues.size()) {
/*     */     case 0: 
/* 406 */       return Optional.absent();
/*     */     case 1: 
/* 408 */       return Optional.of(Charset.forName((String)Iterables.getOnlyElement(charsetValues)));
/*     */     }
/* 410 */     String str = String.valueOf(String.valueOf(charsetValues));throw new IllegalStateException(33 + str.length() + "Multiple charset values defined: " + str);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 444 */     for (Entry<String, String> entry : this.parameters.entries()) {
...
/*     */   {
/* 502 */     return ((mediaTypeRange.type.equals("*")) || (mediaTypeRange.type.equals(this.type))) && ((mediaTypeRange.subtype.equals("*")) || (mediaTypeRange.subtype.equals(this.subtype))) && (this.parameters.entries().containsAll(mediaTypeRange.parameters.entries()));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 514 */     return create(type, subtype, ImmutableListMultimap.of());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 573 */       String attribute = normalizeToken((String)entry.getKey());
/* 574 */       builder.put(attribute, normalizeParameterValue(attribute, (String)entry.getValue()));
/*     */     }
...
/* 601 */       subtype = tokenizer.consumeToken(TOKEN_MATCHER);
...
/* 615 */               valueBuilder.append(tokenizer.consumeCharacter(CharMatcher.ASCII));
/*     */             } else {
/* 617 */               valueBuilder.append(tokenizer.consumeToken(QUOTED_TEXT_MATCHER));
/*     */             }
/*     */           }
/* 620 */           String value = valueBuilder.toString();
...
/* 629 */       String subtype = String.valueOf(String.valueOf(input));throw new IllegalArgumentException(18 + subtype.length() + "Could not parse '" + subtype + "'", e);
/*     */     }
/*     */   }
/*     */   
...
/* 707 */       builder.append("; ");
/* 708 */       Multimap<String, String> quotedParameters = Multimaps.transformValues(this.parameters, new Function()
/*     */       {
