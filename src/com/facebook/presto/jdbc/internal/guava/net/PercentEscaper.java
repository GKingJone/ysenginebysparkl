...
/*     */ import com.facebook.presto.jdbc.internal.guava.escape.UnicodeEscaper;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 146 */       if ((c >= this.safeOctets.length) || (this.safeOctets[c] == 0)) {
/*     */         break;
/*     */       }
/*     */     }
/* 150 */     return index;
...
/* 164 */       if ((c >= this.safeOctets.length) || (this.safeOctets[c] == 0)) {
...
/*     */   {
/* 178 */     if ((cp < this.safeOctets.length) && (this.safeOctets[cp] != 0))
/* 179 */       return null;
...
/*     */     }
/*     */     
/* 247 */     char[] dest = cp;throw new IllegalArgumentException(43 + "Invalid unicode character value " + dest);
/*     */   }
/*     */ }
