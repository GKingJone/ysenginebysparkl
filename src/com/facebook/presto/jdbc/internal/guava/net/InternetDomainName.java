...
/*     */ import com.facebook.presto.jdbc.internal.guava.publicsuffix.PublicSuffixPatterns;
...
/*     */   {
/* 457 */     return from(DOT_JOINER.join(this.parts.subList(levels, this.parts.size())));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 471 */     String str1 = String.valueOf(String.valueOf((String)Preconditions.checkNotNull(leftParts)));String str2 = String.valueOf(String.valueOf(this.name));return from(1 + str1.length() + str2.length() + str1 + "." + str2);
/*     */   }
/*     */   
/*     */ 
/*     */ 
