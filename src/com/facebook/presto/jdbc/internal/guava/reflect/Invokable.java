...
/* 120 */     Builder<Parameter> builder = ImmutableList.builder();
...
/*     */   {
/* 130 */     Builder<TypeToken<? extends Throwable>> builder = ImmutableList.builder();
...
/* 154 */       String str1 = String.valueOf(String.valueOf(getReturnType()));String str2 = String.valueOf(String.valueOf(returnType));throw new IllegalArgumentException(35 + str1.length() + str2.length() + "Invokable is known to return " + str1 + ", not " + str2);
/*     */     }
/*     */     
/*     */ 
/* 158 */     Object specialized = this;
/* 159 */     return (Invokable<T, R1>)specialized;
/*     */   }
/*     */   
...
/* 244 */         String str = String.valueOf(String.valueOf(this.constructor));throw new RuntimeException(8 + str.length() + str + " failed.", e);
/*     */       }
/*     */     }
/*     */     
/*     */     Type getGenericReturnType()
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\reflect\Invokable.class
