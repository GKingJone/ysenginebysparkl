...
/*     */   {
/*  74 */     int i = this.c;int j = this.d;long l1 = this.k0;long l2 = this.k1;return 81 + "Hashing.sipHash" + i + j + "(" + l1 + ", " + l2 + ")";
/*     */   }
/*     */   
...
/* 136 */         this.finalM ^= (buffer.get() & 0xFF) << i;
/*     */       }
/*     */     }
/*     */     
/*     */     public HashCode makeHash()
/*     */     {
/* 142 */       this.finalM ^= this.b << 56;
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\hash\SipHashFunction.class
