...
/*     */   {
/*  67 */     int i = this.seed;return 31 + "Hashing.murmur3_32(" + i + ")";
/*     */   }
/*     */   
...
/* 110 */       int k1 = input.charAt(i - 1) | input.charAt(i) << '\020';
/* 111 */       k1 = mixK1(k1);
/* 112 */       h1 = mixH1(h1, k1);
/*     */     }
/*     */     
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\hash\Murmur3_32HashFunction.class
