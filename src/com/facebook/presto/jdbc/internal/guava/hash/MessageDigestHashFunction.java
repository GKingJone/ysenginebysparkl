...
/*     */       try {
/*  84 */         return new MessageDigestHasher((MessageDigest)this.prototype.clone(), this.bytes, null);
/*     */       }
/*     */       catch (CloneNotSupportedException e) {}
/*     */     }
/*     */     
/*  89 */     return new MessageDigestHasher(getMessageDigest(this.prototype.getAlgorithm()), this.bytes, null);
/*     */   }
/*     */   
...
/*     */     
/*  98 */     private SerializedForm(String algorithmName, int bytes, String toString) { this.algorithmName = algorithmName;
/*  99 */       this.bytes = bytes;
...
/*     */   Object writeReplace()
/*     */   {
/* 111 */     return new SerializedForm(this.prototype.getAlgorithm(), this.bytes, this.toString, null);
/*     */   }
/*     */   
/*     */ 
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\hash\MessageDigestHashFunction.class
