...
/* 256 */     static final HashFunction CRC_32 = Hashing.checksumHashFunction(ChecksumType.CRC_32, "Hashing.crc32()");
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 274 */     static final HashFunction ADLER_32 = Hashing.checksumHashFunction(ChecksumType.ADLER_32, "Hashing.adler32()");
/*     */   }
/*     */   
...
/* 345 */       if ((next < 0) || (next >= buckets)) break;
/* 346 */       candidate = next;
/*     */     }
...
/*     */       
/* 397 */       for (int i = 0; i < nextBytes.length; tmp102_100++) {
/* 398 */         int tmp102_100 = i; byte[] tmp102_99 = resultBytes;tmp102_99[tmp102_100] = ((byte)(tmp102_99[tmp102_100] + nextBytes[tmp102_100]));
/*     */       }
/*     */     }
...
/* 482 */       return ((int)(this.state >>> 33) + 1) / 2.147483648E9D;
/*     */     }
/*     */   }
/*     */ }


/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\hash\Hashing.class
