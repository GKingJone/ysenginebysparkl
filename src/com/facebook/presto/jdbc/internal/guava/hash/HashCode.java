...
/*     */ import com.facebook.presto.jdbc.internal.guava.primitives.UnsignedInts;
...
/*     */     
/* 127 */     IntHashCode(int hash) { this.hash = hash; }
/*     */     
/*     */ 
/*     */     public int bits()
/*     */     {
...
/*     */     private static final long serialVersionUID = 0L;
/*     */     
/* 187 */     LongHashCode(long hash) { this.hash = hash; }
/*     */     
/*     */ 
/*     */     public int bits()
/*     */     {
...
/*     */     public byte[] asBytes()
/*     */     {
/* 197 */       return new byte[] { (byte)(int)this.hash, (byte)(int)(this.hash >> 8), (byte)(int)(this.hash >> 16), (byte)(int)(this.hash >> 24), (byte)(int)(this.hash >> 32), (byte)(int)(this.hash >> 40), (byte)(int)(this.hash >> 48), (byte)(int)(this.hash >> 56) };
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     private static final long serialVersionUID = 0L;
/*     */     
/* 261 */     BytesHashCode(byte[] bytes) { this.bytes = ((byte[])Preconditions.checkNotNull(bytes)); }
/*     */     
/*     */ 
/*     */     public int bits()
/*     */     {
...
/* 295 */         retVal |= (this.bytes[i] & 0xFF) << i * 8;
/*     */       }
/* 297 */       return retVal;
/*     */     }
/*     */     
...
/* 348 */       return ch - 'a' + 10;
/*     */     }
/* 350 */     char c = ch;throw new IllegalArgumentException(32 + "Illegal hexadecimal character: " + c);
/*     */   }
/*     */   
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\hash\HashCode.class
