...
/* 222 */       boolean sqrtFloorIsExact = (sqrtFloorInt * sqrtFloorInt == x.intValue()) && (sqrtFloor.pow(2).equals(x));
/*     */       
/*     */ 
...
/* 264 */     BigInteger sqrt0; BigInteger sqrt0; if (log2 < 1023) {
...
/* 326 */     ArrayList<BigInteger> bignums = new ArrayList(approxSize);
/*     */     
/*     */ 
...
/*     */     
/*     */ 
/* 342 */     for (long num = startingNumber; num <= n; num += 1L)
/*     */     {
...
/*     */     case 1: 
/* 380 */       return (BigInteger)nums.get(start);
/*     */     case 2: 
/* 382 */       return ((BigInteger)nums.get(start)).multiply((BigInteger)nums.get(start + 1));
/*     */     case 3: 
/* 384 */       return ((BigInteger)nums.get(start)).multiply((BigInteger)nums.get(start + 1)).multiply((BigInteger)nums.get(start + 2));
/*     */     }
/*     */     
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\math\BigIntegerMath.class
