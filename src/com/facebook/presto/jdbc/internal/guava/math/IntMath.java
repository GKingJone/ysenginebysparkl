...
/*     */ 
/*     */   @VisibleForTesting
/* 176 */   static final int[] halfPowersOf10 = { 3, 31, 316, 3162, 31622, 316227, 3162277, 31622776, 316227766, Integer.MAX_VALUE };
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */     boolean increment;
/* 299 */     boolean increment; switch (mode) {
/*     */     case UNNECESSARY: 
...
/* 323 */         if (mode != RoundingMode.HALF_UP) {} increment = ((mode == RoundingMode.HALF_EVEN ? 1 : 0) & ((div & 0x1) != 0 ? 1 : 0)) != 0;
/*     */       } else {
...
/*     */   {
/* 351 */     if (m <= 0) {
/* 352 */       int i = m;throw new ArithmeticException(31 + "Modulus " + i + " must be > 0");
/*     */     }
/* 354 */     int result = x % m;
...
/*     */ 
/*     */   @VisibleForTesting
/* 550 */   static int[] biggestBinomials = { Integer.MAX_VALUE, Integer.MAX_VALUE, 65536, 2345, 477, 193, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33 };
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\math\IntMath.class
