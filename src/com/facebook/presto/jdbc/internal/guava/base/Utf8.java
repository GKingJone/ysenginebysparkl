...
/*     */     {
/*  72 */       long l = utf8Length + 4294967296L;throw new IllegalArgumentException(54 + "UTF-8 length does not fit in int: " + l);
/*     */     }
/*     */     
...
/*  86 */         utf8Length += 2;
/*     */         
/*  88 */         if ((55296 <= c) && (c <= 57343))
/*     */         {
/*  90 */           int cp = Character.codePointAt(sequence, i);
/*  91 */           if (cp < 65536) {
/*  92 */             int i = i;throw new IllegalArgumentException(39 + "Unpaired surrogate at index " + i);
/*     */           }
/*  94 */           i++;
/*     */         }
/*     */       }
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\base\Utf8.class
