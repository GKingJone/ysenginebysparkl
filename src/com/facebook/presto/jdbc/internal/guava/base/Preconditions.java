...
/* 318 */     if (size < 0) {
/* 319 */       int i = size;throw new IllegalArgumentException(26 + "negative size: " + i);
/*     */     }
...
/* 361 */     if (size < 0) {
/* 362 */       int i = size;throw new IllegalArgumentException(26 + "negative size: " + i);
/*     */     }
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\base\Preconditions.class
