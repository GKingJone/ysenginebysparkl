...
/* 197 */       String str1 = String.valueOf(String.valueOf(this.sourceFormat));String str2 = String.valueOf(String.valueOf(this.targetFormat));return 14 + str1.length() + str2.length() + str1 + ".converterTo(" + str2 + ")";
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\base\CaseFormat.class
