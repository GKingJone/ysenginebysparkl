...
/*     */   {
/* 144 */     String str1 = String.valueOf(String.valueOf(key()));String str2 = String.valueOf(String.valueOf(value()));return 1 + str1.length() + str2.length() + str1 + "=" + str2;
/*     */   }
/*     */ }


/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\base\StandardSystemProperty.class
