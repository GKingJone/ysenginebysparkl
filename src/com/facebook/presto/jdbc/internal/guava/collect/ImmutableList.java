...
/*     */   {
/*  89 */     return new SingletonImmutableList(element);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 226 */     return (elements instanceof Collection) ? copyOf((Collection)elements) : copyOf(elements.iterator());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/*     */     case 1: 
/* 325 */       ImmutableList<E> list = new SingletonImmutableList(elements[0]);
/* 326 */       return list;
/*     */     }
...
/* 348 */     new AbstractIndexedListIterator(size(), index)
/*     */     {
/*     */       protected E get(int index) {
/* 351 */         return (E)ImmutableList.this.get(index);
/*     */       }
/*     */     };
/*     */   }
/*     */   
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\ImmutableList.class
