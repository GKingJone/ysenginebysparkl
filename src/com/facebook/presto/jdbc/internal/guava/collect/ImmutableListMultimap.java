...
/*     */     
/*     */ 
/* 260 */     for (Entry<? extends K, ? extends Collection<? extends V>> entry : multimap.asMap().entrySet()) {
/* 261 */       ImmutableList<V> list = ImmutableList.copyOf((Collection)entry.getValue());
/* 262 */       if (!list.isEmpty()) {
...
/*     */     }
/*     */     
/* 268 */     return new ImmutableListMultimap(builder.build(), size);
/*     */   }
/*     */   
...
/*     */   {
/* 285 */     ImmutableList<V> list = (ImmutableList)this.map.get(key);
/* 286 */     return list == null ? ImmutableList.of() : list;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 353 */     if (keyCount < 0) {
/* 354 */       int i = keyCount;throw new InvalidObjectException(29 + "Invalid key count " + i);
/*     */     }
/* 356 */     Object builder = ImmutableMap.builder();
/*     */     
/* 358 */     int tmpSize = 0;
/*     */     
...
/* 363 */       if (valueCount <= 0) {
/* 364 */         int j = valueCount;throw new InvalidObjectException(31 + "Invalid value count " + j);
/*     */       }
/*     */       
...
/*     */       }
/* 371 */       ((ImmutableMap.Builder)builder).put(key, ImmutableList.copyOf(array));
/* 372 */       tmpSize += valueCount;
/*     */     }
/*     */     ImmutableMap<Object, ImmutableList<Object>> tmpMap;
/*     */     try
/*     */     {
/* 377 */       tmpMap = ((ImmutableMap.Builder)builder).build();
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\ImmutableListMultimap.class
