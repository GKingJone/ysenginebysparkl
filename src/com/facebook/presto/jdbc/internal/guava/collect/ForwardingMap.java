...
/*     */   {
/*  80 */     return (V)delegate().remove(object);
/*     */   }
/*     */   
/*     */   public void clear()
/*     */   {
...
/*     */   {
/* 100 */     return (V)delegate().get(key);
/*     */   }
/*     */   
/*     */   public V put(K key, V value)
/*     */   {
/* 105 */     return (V)delegate().put(key, value);
/*     */   }
/*     */   
...
/* 163 */       Entry<K, V> entry = (Entry)entryIterator.next();
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\ForwardingMap.class
