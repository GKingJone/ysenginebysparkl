...
/*  84 */     this.iterable = ((Iterable)Preconditions.checkNotNull(iterable));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/*  92 */     (iterable instanceof FluentIterable) ? (FluentIterable)iterable : new FluentIterable(iterable)
/*     */     {
...
/*     */   {
/* 111 */     return (FluentIterable)Preconditions.checkNotNull(iterable);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 293 */       List<E> list = (List)this.iterable;
/* 294 */       if (list.isEmpty()) {
...
/* 310 */       SortedSet<E> sortedSet = (SortedSet)this.iterable;
...
/*     */   {
/* 386 */     return Ordering.from(comparator).immutableSortedCopy(this.iterable);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 487 */     if ((this.iterable instanceof Collection)) {
...
/*     */   {
/* 517 */     return (E)Iterables.get(this.iterable, position);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\FluentIterable.class
