...
/* 258 */         return previous == null ? Cut.belowAll() : new AboveValue(previous);
/*     */       }
...
/* 267 */         return previous == null ? Cut.aboveAll() : new AboveValue(previous);
/*     */       case 2: 
/* 269 */         return this;
/*     */       }
...
/*     */     
/*     */     public String toString() {
/* 290 */       String str = String.valueOf(String.valueOf(this.endpoint));return 2 + str.length() + "\\" + str + "/";
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/*     */     public String toString() {
/* 355 */       String str = String.valueOf(String.valueOf(this.endpoint));return 2 + str.length() + "/" + str + "\\";
/*     */     }
/*     */   }
/*     */ }


/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\Cut.class
