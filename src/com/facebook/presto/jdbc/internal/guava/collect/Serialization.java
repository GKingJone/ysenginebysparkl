...
/*  64 */     for (Entry<K, V> entry : map.entrySet()) {
...
/*     */     {
/*  89 */       K key = stream.readObject();
/*     */       
/*  91 */       V value = stream.readObject();
...
/*     */     {
/* 135 */       E element = stream.readObject();
...
/* 154 */     for (Entry<K, Collection<V>> entry : multimap.asMap().entrySet()) {
/* 155 */       stream.writeObject(entry.getKey());
/* 156 */       stream.writeInt(((Collection)entry.getValue()).size());
/* 157 */       for (V value : (Collection)entry.getValue()) {
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\Serialization.class
