...
/*     */     ComplementRanges()
/*     */     {
/* 195 */       this.positiveBoundedBelow = ((Range)ImmutableRangeSet.this.ranges.get(0)).hasLowerBound();
/* 196 */       this.positiveBoundedAbove = ((Range)Iterables.getLast(ImmutableRangeSet.this.ranges)).hasUpperBound();
/*     */       
...
/* 219 */         lowerBound = index == 0 ? Cut.belowAll() : ((Range)ImmutableRangeSet.this.ranges.get(index - 1)).upperBound;
/*     */       } else {
...
/* 298 */           return ((Range)ImmutableRangeSet.this.ranges.get(index + fromIndex)).intersection(range);
/*     */         }
/* 300 */         return (Range)ImmutableRangeSet.this.ranges.get(index + fromIndex);
/*     */       }
/*     */       
/*     */ 
/*     */       boolean isPartialView()
...
/* 407 */               this.elemItr = ContiguousSet.create((Range)this.rangeItr.next(), AsSet.this.domain).iterator();
/*     */             } else {
/* 409 */               return (Comparable)endOfData();
/*     */             }
/*     */           }
/* 412 */           return (Comparable)this.elemItr.next();
/*     */         }
/*     */       };
/*     */     }
/*     */     
...
/* 428 */               this.elemItr = ContiguousSet.create((Range)this.rangeItr.next(), AsSet.this.domain).descendingIterator();
/*     */             } else {
/* 430 */               return (Comparable)endOfData();
/*     */             }
/*     */           }
/* 433 */           return (Comparable)this.elemItr.next();
/*     */         }
/*     */       };
/*     */     }
/*     */     
...
/*     */     Object writeReplace()
/*     */     {
/* 507 */       return new AsSetSerializedForm(ImmutableRangeSet.this.ranges, this.domain);
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/*     */     Object readResolve() {
/* 521 */       return new ImmutableRangeSet(this.ranges).asSet(this.domain);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* 561 */         String str = String.valueOf(String.valueOf(range));throw new IllegalArgumentException(33 + str.length() + "range must not be empty, but was " + str); }
...
/*     */     {
/* 589 */       return ImmutableRangeSet.copyOf(this.rangeSet);
/*     */     }
/*     */   }
/*     */   
...
/*     */   Object writeReplace()
/*     */   {
/* 612 */     return new SerializedForm(this.ranges);
/*     */   }
/*     */ }


/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\ImmutableRangeSet.class
