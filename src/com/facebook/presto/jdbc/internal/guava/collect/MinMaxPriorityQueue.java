...
/*     */   {
/*  98 */     return new Builder(Ordering.natural(), null).create();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 107 */     return new Builder(Ordering.natural(), null).create(initialContents);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 116 */     return new Builder(comparator, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 125 */     return new Builder(Ordering.natural(), null).expectedSize(expectedSize);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 137 */     return new Builder(Ordering.natural(), null).maximumSize(maximumSize);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     {
/* 206 */       MinMaxPriorityQueue<T> queue = new MinMaxPriorityQueue(this, MinMaxPriorityQueue.initialQueueSize(this.expectedSize, this.maximumSize, initialContents), null);
/*     */       
...
/*     */       {
/* 527 */         return new MoveDesc(toTrickle, parent);
/*     */       }
/* 529 */       return null;
/*     */     }
/*     */     
...
/* 787 */         MoveDesc<E> moved = MinMaxPriorityQueue.this.removeAt(this.cursor);
/* 788 */         if (moved != null) {
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\MinMaxPriorityQueue.class
