...
/*     */   
/*     */   @VisibleForTesting
/* 265 */   static class ArbitraryOrdering extends Ordering<Object> { private Map<Object, Integer> uids = Platform.tryWeakKeys(new MapMaker()).makeComputingMap(new Function()
/*     */     {
/*     */ 
/*     */ 
...
/*     */       
/*     */ 
/* 291 */       int result = ((Integer)this.uids.get(left)).compareTo((Integer)this.uids.get(right));
/* 292 */       if (result == 0) {
...
/*     */   {
/* 344 */     return new NullsFirstOrdering(this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 355 */     return new NullsLastOrdering(this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 390 */     return new CompoundOrdering(this, (Comparator)Preconditions.checkNotNull(secondaryComparator));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 411 */     return new CompoundOrdering(comparators);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 440 */     return new LexicographicalOrdering(this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 482 */     return (E)min(iterable.iterator());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 558 */     return (E)max(iterable.iterator());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 616 */       Collection<E> collection = (Collection)iterable;
...
/*     */ 
/*     */ 
/* 623 */         E[] array = (Object[])collection.toArray();
...
/*     */     
/* 681 */     E[] buffer = (Object[])new Object[bufferCap];
...
/* 716 */             } else { if (pivotNewIndex >= k) break;
...
/*     */   {
/* 816 */     E[] array = (Object[])Iterables.toArray(elements);
...
/*     */   {
/* 842 */     E[] array = (Object[])Iterables.toArray(elements);
/* 843 */     for (E e : array) {
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\Ordering.class
