...
/*      */     {
/*  136 */       return Iterators.unmodifiableIterator(this.delegate.iterator());
/*      */     }
/*      */     
...
/*      */   {
/*  200 */     return new UnmodifiableSortedMultiset((SortedMultiset)Preconditions.checkNotNull(sortedMultiset));
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     {
/*  299 */       Sets.filter(this.unfiltered.entrySet(), new Predicate()
/*      */       {
/*      */         public boolean apply(Multiset.Entry<E> entry) {
/*  302 */           return FilteredMultiset.this.predicate.apply(entry.getElement());
/*      */         }
/*      */       });
/*      */     }
/*      */     
...
/*      */     
/*  385 */     new AbstractMultiset()
/*      */     {
/*      */       public boolean contains(@Nullable Object element) {
/*  388 */         return (this.val$multiset1.contains(element)) || (multiset2.contains(element));
/*      */       }
/*      */       
/*      */       public boolean isEmpty()
/*      */       {
/*  393 */         return (this.val$multiset1.isEmpty()) && (multiset2.isEmpty());
/*      */       }
/*      */       
/*      */       public int count(Object element)
/*      */       {
/*  398 */         return Math.max(this.val$multiset1.count(element), multiset2.count(element));
/*      */       }
/*      */       
/*      */       Set<E> createElementSet()
/*      */       {
/*  403 */         return Sets.union(this.val$multiset1.elementSet(), multiset2.elementSet());
/*      */       }
/*      */       
/*      */       Iterator<Multiset.Entry<E>> entryIterator()
/*      */       {
/*  408 */         final Iterator<? extends Multiset.Entry<? extends E>> iterator1 = this.val$multiset1.entrySet().iterator();
/*      */         
/*  410 */         final Iterator<? extends Multiset.Entry<? extends E>> iterator2 = multiset2.entrySet().iterator();
/*      */         
/*      */ 
/*  413 */         new AbstractIterator()
/*      */         {
...
/*  419 */               int count = Math.max(entry1.getCount(), Multisets.1.this.val$multiset2.count(element));
...
/*  425 */               if (!Multisets.1.this.val$multiset1.contains(element)) {
...
/*      */     
/*  460 */     new AbstractMultiset()
/*      */     {
/*      */       public int count(Object element) {
/*  463 */         int count1 = this.val$multiset1.count(element);
/*  464 */         return count1 == 0 ? 0 : Math.min(count1, multiset2.count(element));
/*      */       }
/*      */       
/*      */       Set<E> createElementSet()
/*      */       {
/*  469 */         return Sets.intersection(this.val$multiset1.elementSet(), multiset2.elementSet());
/*      */       }
/*      */       
/*      */ 
/*      */       Iterator<Multiset.Entry<E>> entryIterator()
/*      */       {
/*  475 */         final Iterator<Multiset.Entry<E>> iterator1 = this.val$multiset1.entrySet().iterator();
/*      */         
/*  477 */         new AbstractIterator()
/*      */         {
/*      */           protected Multiset.Entry<E> computeNext() {
/*  480 */             while (iterator1.hasNext()) {
/*  481 */               Multiset.Entry<E> entry1 = (Multiset.Entry)iterator1.next();
/*  482 */               E element = entry1.getElement();
/*  483 */               int count = Math.min(entry1.getCount(), Multisets.2.this.val$multiset2.count(element));
/*  484 */               if (count > 0) {
...
/*      */     
/*      */ 
/*  522 */     new AbstractMultiset()
/*      */     {
/*      */       public boolean contains(@Nullable Object element) {
/*  525 */         return (this.val$multiset1.contains(element)) || (multiset2.contains(element));
/*      */       }
/*      */       
/*      */       public boolean isEmpty()
/*      */       {
/*  530 */         return (this.val$multiset1.isEmpty()) && (multiset2.isEmpty());
/*      */       }
/*      */       
/*      */       public int size()
/*      */       {
/*  535 */         return this.val$multiset1.size() + multiset2.size();
/*      */       }
/*      */       
/*      */       public int count(Object element)
/*      */       {
/*  540 */         return this.val$multiset1.count(element) + multiset2.count(element);
/*      */       }
/*      */       
/*      */       Set<E> createElementSet()
/*      */       {
/*  545 */         return Sets.union(this.val$multiset1.elementSet(), multiset2.elementSet());
/*      */       }
/*      */       
/*      */       Iterator<Multiset.Entry<E>> entryIterator()
/*      */       {
/*  550 */         final Iterator<? extends Multiset.Entry<? extends E>> iterator1 = this.val$multiset1.entrySet().iterator();
/*      */         
/*  552 */         final Iterator<? extends Multiset.Entry<? extends E>> iterator2 = multiset2.entrySet().iterator();
/*      */         
/*  554 */         new AbstractIterator()
/*      */         {
/*      */           protected Multiset.Entry<E> computeNext() {
/*  557 */             if (iterator1.hasNext()) {
/*  558 */               Multiset.Entry<? extends E> entry1 = (Multiset.Entry)iterator1.next();
/*  559 */               E element = entry1.getElement();
/*  560 */               int count = entry1.getCount() + Multisets.3.this.val$multiset2.count(element);
...
/*  566 */               if (!Multisets.3.this.val$multiset1.contains(element)) {
...
/*      */     
/*      */ 
/*  604 */     new AbstractMultiset()
/*      */     {
/*      */       public int count(@Nullable Object element) {
/*  607 */         int count1 = this.val$multiset1.count(element);
...
/*      */       Iterator<Multiset.Entry<E>> entryIterator()
/*      */       {
/*  614 */         final Iterator<Multiset.Entry<E>> iterator1 = this.val$multiset1.entrySet().iterator();
/*  615 */         new AbstractIterator()
/*      */         {
/*      */           protected Multiset.Entry<E> computeNext() {
/*  618 */             while (iterator1.hasNext()) {
/*  619 */               Multiset.Entry<E> entry1 = (Multiset.Entry)iterator1.next();
/*  620 */               E element = entry1.getElement();
/*  621 */               int count = entry1.getCount() - Multisets.4.this.val$multiset2.count(element);
/*  622 */               if (count > 0) {
...
/*  762 */       Multiset.Entry<E> entry = (Multiset.Entry)entryIterator.next();
...
/*  811 */       int n = getCount();
/*  812 */       String str1 = String.valueOf(String.valueOf(text));int i = n;return 14 + str1.length() + str1 + " x " + i;
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*      */     
/*      */     public Iterator<E> iterator() {
/*  941 */       new TransformedIterator(multiset().entrySet().iterator())
/*      */       {
/*      */         E transform(Multiset.Entry<E> entry) {
/*  944 */           return (E)entry.getElement();
/*      */         }
/*      */       };
/*      */     }
/*      */     
...
/*      */         {
/*      */ 
/*  994 */           Multiset<Object> multiset = multiset();
...
/* 1041 */         this.currentEntry = ((Multiset.Entry)this.entryIterator.next());
/* 1042 */         this.totalCount = (this.laterCount = this.currentEntry.getCount());
/*      */       }
/* 1044 */       this.laterCount -= 1;
/* 1045 */       this.canRemove = true;
/* 1046 */       return (E)this.currentEntry.getElement();
/*      */     }
/*      */     
/*      */     public void remove()
/*      */     {
...
/*      */   }
/*      */   
/* 1080 */   private static final Ordering<Multiset.Entry<?>> DECREASING_COUNT_ORDERING = new Ordering()
/*      */   {
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\Multisets.class
