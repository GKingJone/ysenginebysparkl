...
/*     */   {
/* 257 */     return this.comparator + ":" + (this.lowerBoundType == BoundType.CLOSED ? '[' : '(') + (this.hasLowerBound ? this.lowerEndpoint : "-∞") + ',' + (this.hasUpperBound ? this.upperEndpoint : "∞") + (this.upperBoundType == BoundType.CLOSED ? ']' : ')');
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   T getLowerEndpoint()
/*     */   {
/* 269 */     return (T)this.lowerEndpoint;
/*     */   }
/*     */   
...
/*     */   
/*     */   T getUpperEndpoint() {
/* 277 */     return (T)this.upperEndpoint;
/*     */   }
/*     */   
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\GeneralRange.class
