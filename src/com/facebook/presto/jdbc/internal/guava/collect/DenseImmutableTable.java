...
/*     */   {
/*  56 */     V[][] array = (Object[][])new Object[rowSpace.size()][columnSpace.size()];
...
/*     */     
/*     */     K getKey(int index) {
/* 102 */       return (K)keyToIndex().keySet().asList().get(index);
/*     */     }
/*     */     
/*     */     @Nullable
...
/*     */         {
/* 132 */           new AbstractIterator() {
/* 133 */             private int index = -1;
/* 134 */             private final int maxIndex = ImmutableArrayMap.this.keyToIndex().size();
/*     */             
/*     */             protected Entry<K, V> computeNext()
/*     */             {
/* 138 */               for (this.index += 1; this.index < this.maxIndex; this.index += 1) {
/* 139 */                 V value = ImmutableArrayMap.this.getValue(this.index);
/* 140 */                 if (value != null) {
/* 141 */                   return Maps.immutableEntry(ImmutableArrayMap.this.getKey(this.index), value);
/*     */                 }
/*     */               }
/* 144 */               return (Entry)endOfData();
/*     */             }
/*     */           };
/*     */         }
/*     */       };
...
/*     */     {
/* 212 */       return new Row(DenseImmutableTable.this, keyIndex);
/*     */     }
/*     */     
/*     */     boolean isPartialView()
/*     */     {
...
/*     */     {
/* 233 */       return new Column(DenseImmutableTable.this, keyIndex);
/*     */     }
/*     */     
/*     */     boolean isPartialView()
/*     */     {
...
/*     */   {
/* 276 */     return (V)this.values[this.iterationOrderRow[index]][this.iterationOrderColumn[index]];
/*     */   }
/*     */ }


/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\DenseImmutableTable.class
