...
/*      */   {
/*  289 */     return (T)Iterators.getOnlyElement(iterable.iterator());
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/*  302 */     return (T)Iterators.getOnlyElement(iterable.iterator(), defaultValue);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/*  337 */     return (iterable instanceof Collection) ? (Collection)iterable : Lists.newArrayList(iterable.iterator());
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  392 */     new FluentIterable()
/*      */     {
/*      */       public Iterator<T> iterator() {
/*  395 */         return Iterators.cycle(this.val$iterable);
/*      */       }
/*      */       
/*  398 */       public String toString() { return String.valueOf(this.val$iterable.toString()).concat(" (cycled)"); }
/*      */     };
/*      */   }
/*      */   
/*      */ 
...
/*  495 */     new FluentIterable()
/*      */     {
/*      */       public Iterator<T> iterator() {
/*  498 */         return Iterators.concat(Iterables.iterators(this.val$inputs));
/*      */       }
/*      */     };
/*      */   }
/*      */   
...
/*      */   {
/*  508 */     new TransformedIterator(iterables.iterator())
/*      */     {
...
/*      */   {
/*  646 */     return (T)Iterators.find(iterable.iterator(), predicate);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/*  660 */     return (T)Iterators.find(iterable.iterator(), predicate, defaultValue);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  710 */     new FluentIterable()
/*      */     {
/*      */       public Iterator<T> iterator() {
/*  713 */         return Iterators.transform(this.val$fromIterable.iterator(), function);
/*      */       }
/*      */     };
/*      */   }
/*      */   
...
/*      */   {
/*  775 */     return (T)Iterators.getNext(iterable.iterator(), defaultValue);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  820 */     return (T)list.get(list.size() - 1);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  849 */       List<T> list = (List)iterable;
/*  850 */       new FluentIterable()
/*      */       {
/*      */         public Iterator<T> iterator()
/*      */         {
/*  854 */           int toSkip = Math.min(this.val$list.size(), numberToSkip);
/*  855 */           return this.val$list.subList(toSkip, this.val$list.size()).iterator();
/*      */         }
/*      */       };
/*      */     }
/*      */     
/*  860 */     new FluentIterable()
/*      */     {
/*      */       public Iterator<T> iterator() {
/*  863 */         final Iterator<T> iterator = this.val$iterable.iterator();
/*      */         
...
/*  913 */     new FluentIterable()
/*      */     {
/*      */       public Iterator<T> iterator() {
/*  916 */         return Iterators.limit(this.val$iterable.iterator(), limitSize);
/*      */       }
/*      */     };
/*      */   }
/*      */   
...
/*  942 */       new FluentIterable()
/*      */       {
/*      */         public Iterator<T> iterator() {
/*  945 */           return new ConsumingQueueIterator((Queue)this.val$iterable, null);
/*      */         }
/*      */         
/*      */         public String toString()
/*      */         {
...
/*      */     
/*  957 */     new FluentIterable()
/*      */     {
/*      */       public Iterator<T> iterator() {
/*  960 */         return Iterators.consumingIterator(this.val$iterable.iterator());
/*      */       }
/*      */       
/*      */       public String toString()
/*      */       {
...
/*      */     {
/*      */       public Iterator<T> iterator() {
/* 1025 */         return Iterators.mergeSorted(Iterables.transform(this.val$iterables, Iterables.access$300()), comparator);
/*      */       }
/*      */       
/*      */ 
/* 1029 */     };
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\Iterables.class
