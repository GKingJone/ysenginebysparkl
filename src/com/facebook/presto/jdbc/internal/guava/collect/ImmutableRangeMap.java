...
/* 109 */       if (!this.keyRanges.complement().encloses(range)) { String str1;
/*     */         String str2;
/* 111 */         for (Iterator i$ = this.rangeMap.asMapOfRanges().entrySet().iterator(); i$.hasNext(); 
/*     */             
/*     */ 
/* 114 */             throw new IllegalArgumentException(47 + str1.length() + str2.length() + "Overlapping ranges: range " + str1 + " overlaps with entry " + str2))
/*     */         {
/* 111 */           Entry<Range<K>, V> entry = (Entry)i$.next();
/* 112 */           Range<K> key = (Range)entry.getKey();
/* 113 */           if ((key.isConnected(range)) && (!key.intersection(range).isEmpty())) {
/* 114 */             str1 = String.valueOf(String.valueOf(range));str2 = String.valueOf(String.valueOf(entry));
/*     */           }
/*     */         }
/*     */       }
/*     */       
...
/* 143 */       ImmutableList.Builder<Range<K>> rangesBuilder = new ImmutableList.Builder(map.size());
/*     */       
/* 145 */       ImmutableList.Builder<V> valuesBuilder = new ImmutableList.Builder(map.size());
...
/*     */     }
/* 223 */     RegularImmutableSortedSet<Range<K>> rangeSet = new RegularImmutableSortedSet(this.ranges, Range.RANGE_LEX_ORDERING);
/*     */     
...
/* 246 */     ImmutableList<Range<K>> subRanges = new ImmutableList()
/*     */     {
/*     */       public int size() {
/* 249 */         return len;
/*     */       }
...
/* 268 */     new ImmutableRangeMap(subRanges, this.values.subList(lowerIndex, upperIndex))
/*     */     {
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\ImmutableRangeMap.class
