...
/*     */   {
/*  87 */     return new ConcurrentHashMultiset(new ConcurrentHashMap());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 127 */     return new ConcurrentHashMultiset(mapMaker.makeMap());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 191 */     for (Entry<E> entry : entrySet()) {
...
/*     */     for (;;)
/*     */     {
/* 219 */       AtomicInteger existingCounter = (AtomicInteger)Maps.safeGet(this.countMap, element);
...
/* 238 */             int i = occurrences;int j = oldValue;throw new IllegalArgumentException(65 + "Overflow adding " + i + " occurrences to a count of " + j);
/*     */           }
/*     */         }
/*     */         
/*     */ 
...
/* 246 */         if ((this.countMap.putIfAbsent(element, newCounter) != null) && (!this.countMap.replace(element, existingCounter, newCounter)))
/*     */           break;
/* 248 */         return 0;
/*     */       }
/*     */     }
...
/*     */     for (;;) {
/* 353 */       AtomicInteger existingCounter = (AtomicInteger)Maps.safeGet(this.countMap, element);
...
/*     */   {
/* 490 */     final Iterator<Entry<E>> readOnlyIterator = new AbstractIterator()
/*     */     {
...
/* 497 */             return (Entry)endOfData();
/*     */           }
/* 499 */           Map.Entry<E, AtomicInteger> mapEntry = (Map.Entry)this.mapEntries.next();
...
/*     */       
/*     */       public Entry<E> next() {
/* 516 */         this.last = ((Entry)super.next());
...
/*     */   
/*     */ 
/* 529 */   public void clear() { this.countMap.clear(); }
/*     */   
/*     */   private class EntrySet extends AbstractMultiset<E>.EntrySet {
/* 532 */     private EntrySet() { super(); }
/*     */     
/* 534 */     ConcurrentHashMultiset<E> multiset() { return ConcurrentHashMultiset.this; }
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/* 551 */       List<Entry<E>> list = Lists.newArrayListWithExpectedSize(size());
/*     */       
...
/*     */     
/* 569 */     ConcurrentMap<E, Integer> deserializedCountMap = (ConcurrentMap)stream.readObject();
/*     */     
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\ConcurrentHashMultiset.class
