...
/*     */   {
/* 149 */     if (!safe) {
/* 150 */       String str1 = String.valueOf(String.valueOf(conflictDescription));String str2 = String.valueOf(String.valueOf(entry1));String str3 = String.valueOf(String.valueOf(entry2));throw new IllegalArgumentException(34 + str1.length() + str2.length() + str3.length() + "Multiple entries with same " + str1 + ": " + str2 + " and " + str3);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/*     */     case 1: 
/* 291 */       Entry<K, V> onlyEntry = entries[0];
...
/* 307 */     for (Entry<?, ?> entry : copy.entrySet()) {
...
/*     */   {
/* 392 */     ImmutableSet<Entry<K, V>> result = this.entrySet;
...
/*     */         {
/* 482 */           final Iterator<Entry<K, V>> backingIterator = ImmutableMap.this.entrySet().iterator();
...
/* 489 */               final Entry<K, V> backingEntry = (Entry)backingIterator.next();
...
/*     */     }
/*     */     
/* 541 */     Object readResolve() { Builder<Object, Object> builder = new Builder();
/* 542 */       return createMap(builder);
/*     */     }
/*     */     
/* 545 */     Object createMap(Builder<Object, Object> builder) { for (int i = 0; i < this.keys.length; i++) {
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\ImmutableMap.class
