...
/*     */   {
/* 247 */     return new TransformedCollection(fromCollection, function);
/*     */   }
/*     */   
...
/*     */     
/* 299 */     STANDARD_JOINER.appendTo(sb, Iterables.transform(collection, new Function()
/*     */     {
/*     */       public Object apply(Object input) {
/* 302 */         return input == this.val$collection ? "(this Collection)" : input;
/*     */       }
/* 304 */     }));
/* 305 */     return ']';
/*     */   }
...
/*     */   {
/* 406 */     return new OrderedPermutationCollection(elements, comparator);
/*     */   }
/*     */   
...
/* 466 */       return new OrderedPermutationIterator(this.inputList, this.comparator);
/*     */     }
/*     */     
...
/* 478 */       String str = String.valueOf(String.valueOf(this.inputList));return 30 + str.length() + "orderedPermutationCollection(" + str + ")";
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/* 559 */     return new PermutationCollection(ImmutableList.copyOf(elements));
/*     */   }
/*     */   
...
/*     */     
/*     */     public Iterator<List<E>> iterator() {
/* 579 */       return new PermutationIterator(this.inputList);
/*     */     }
/*     */     
/*     */     public boolean contains(@Nullable Object obj) {
...
/*     */     
/*     */     public String toString() {
/* 591 */       String str = String.valueOf(String.valueOf(this.inputList));return 14 + str.length() + "permutations(" + str + ")";
/*     */     }
/*     */   }
/*     */   
...
/*     */       int q;
/*     */       for (;;) {
/* 632 */         q = this.c[this.j] + this.o[this.j];
/* 633 */         if (q < 0) {
/* 634 */           switchDirection();
/*     */         }
/*     */         else {
/* 637 */           if (q != this.j + 1) break;
/* 638 */           if (this.j == 0) {
/*     */             return;
/*     */           }
/* 641 */           s++;
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\Collections2.class
