...
/*      */   
/*      */   @VisibleForTesting
/*  119 */   static int computeArrayListCapacity(int arraySize) { CollectPreconditions.checkNonnegative(arraySize, "arraySize");
/*      */     
/*      */ 
...
/*      */     
/*  144 */     return (elements instanceof Collection) ? new ArrayList(Collections2.cast(elements)) : newArrayList(elements.iterator());
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  186 */     return new ArrayList(initialArraySize);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/*  289 */     Collection<? extends E> elementsCollection = (elements instanceof Collection) ? Collections2.cast(elements) : newArrayList(elements);
/*      */     
/*      */ 
...
/*  323 */       this.rest = ((Object[])Preconditions.checkNotNull(rest));
/*      */     }
/*      */     
/*  326 */     public int size() { return this.rest.length + 1; }
/*      */     
/*      */     public E get(int index)
/*      */     {
/*  330 */       Preconditions.checkElementIndex(index, size());
/*  331 */       return (E)(index == 0 ? this.first : this.rest[(index - 1)]);
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*      */   {
/*  355 */     return new TwoPlusArrayList(first, second, rest);
/*      */   }
/*      */   
...
/*  368 */       this.rest = ((Object[])Preconditions.checkNotNull(rest));
/*      */     }
/*      */     
/*  371 */     public int size() { return this.rest.length + 2; }
/*      */     
/*      */     public E get(int index) {
/*  374 */       switch (index) {
/*      */       case 0: 
/*  376 */         return (E)this.first;
/*      */       case 1: 
/*  378 */         return (E)this.second;
/*      */       }
/*      */       
/*  381 */       Preconditions.checkElementIndex(index, size());
/*  382 */       return (E)this.rest[(index - 2)];
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*      */   {
/*  543 */     return (fromList instanceof RandomAccess) ? new TransformingRandomAccessList(fromList, function) : new TransformingSequentialList(fromList, function);
/*      */   }
/*      */   
/*      */ 
...
/*      */     {
/*  560 */       this.fromList = ((List)Preconditions.checkNotNull(fromList));
/*  561 */       this.function = ((Function)Preconditions.checkNotNull(function));
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */     }
/*      */     
/*  572 */     public int size() { return this.fromList.size(); }
/*      */     
/*      */     public ListIterator<T> listIterator(int index) {
/*  575 */       new TransformedListIterator(this.fromList.listIterator(index))
/*      */       {
/*      */         T transform(F from) {
/*  578 */           return (T)TransformingSequentialList.this.function.apply(from);
/*      */         }
/*      */       };
/*      */     }
/*      */   }
...
/*      */     {
/*  601 */       this.fromList = ((List)Preconditions.checkNotNull(fromList));
/*  602 */       this.function = ((Function)Preconditions.checkNotNull(function));
/*      */     }
/*      */     
/*  605 */     public void clear() { this.fromList.clear(); }
/*      */     
/*      */     public T get(int index) {
/*  608 */       return (T)this.function.apply(this.fromList.get(index));
/*      */     }
/*      */     
/*  611 */     public Iterator<T> iterator() { return listIterator(); }
/*      */     
/*      */     public ListIterator<T> listIterator(int index) {
/*  614 */       new TransformedListIterator(this.fromList.listIterator(index))
/*      */       {
/*      */         T transform(F from) {
/*  617 */           return (T)TransformingRandomAccessList.this.function.apply(from);
/*      */         }
/*      */       };
/*      */     }
/*      */     
/*  622 */     public boolean isEmpty() { return this.fromList.isEmpty(); }
/*      */     
/*      */     public T remove(int index) {
/*  625 */       return (T)this.function.apply(this.fromList.remove(index));
/*      */     }
/*      */     
/*  628 */     public int size() { return this.fromList.size(); }
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  654 */     return (list instanceof RandomAccess) ? new RandomAccessPartition(list, size) : new Partition(list, size);
/*      */   }
/*      */   
...
/*  802 */       this.forwardList = ((List)Preconditions.checkNotNull(forwardList));
/*      */     }
/*      */     
...
/*      */     
/*      */     public T remove(int index) {
/*  830 */       return (T)this.forwardList.remove(reverseIndex(index));
/*      */     }
/*      */     
...
/*  838 */       return (T)this.forwardList.set(reverseIndex(index), element);
/*      */     }
/*      */     
/*      */     public T get(int index) {
/*  842 */       return (T)this.forwardList.get(reverseIndex(index));
/*      */     }
/*      */     
/*      */     public int size() {
...
/*  885 */           return (T)forwardIterator.previous();
/*      */         }
/*      */         
/*      */         public int nextIndex() {
/*  889 */           return ReverseList.this.reversePosition(forwardIterator.nextIndex());
/*      */         }
/*      */         
/*      */         public T previous() {
/*  893 */           if (!hasPrevious()) {
...
/*  897 */           return (T)forwardIterator.next();
/*      */         }
/*      */         
...
/*      */   {
/* 1001 */     return new AbstractListWrapper(list).listIterator(index);
/*      */   }
/*      */   
/*      */ 
...
/* 1011 */       wrapper = new RandomAccessListWrapper(list) { private static final long serialVersionUID = 0L;
/*      */         
/* 1013 */         public ListIterator<E> listIterator(int index) { return this.backingList.listIterator(index);
/*      */         }
/*      */ 
/*      */       };
/*      */     }
/*      */     else {
/* 1019 */       wrapper = new AbstractListWrapper(list) { private static final long serialVersionUID = 0L;
/*      */         
/* 1021 */         public ListIterator<E> listIterator(int index) { return this.backingList.listIterator(index); }
/*      */       };
/*      */     }
/*      */     
/*      */ 
...
/* 1034 */       this.backingList = ((List)Preconditions.checkNotNull(backingList));
/*      */     }
/*      */     
...
/*      */     
/*      */     public E get(int index) {
/* 1046 */       return (E)this.backingList.get(index);
/*      */     }
/*      */     
/*      */     public E remove(int index) {
/* 1050 */       return (E)this.backingList.remove(index);
/*      */     }
/*      */     
/*      */     public E set(int index, E element) {
/* 1054 */       return (E)this.backingList.set(index, element);
/*      */     }
/*      */     
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\collect\Lists.class
