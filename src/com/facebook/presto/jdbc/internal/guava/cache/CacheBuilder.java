...
/*     */   
/* 182 */   static final Supplier<AbstractCache.StatsCounter> CACHE_STATS_COUNTER = new Supplier()
/*     */   {
...
/*     */   }
/*     */   
/* 198 */   static enum OneWeigher implements Weigher<Object, Object> { INSTANCE;
/*     */     
/*     */     private OneWeigher() {}
/*     */     
/* 202 */     public int weigh(Object key, Object value) { return 1; }
/*     */   }
/*     */   
/*     */ 
...
/* 299 */     return (Equivalence)MoreObjects.firstNonNull(this.keyEquivalence, getKeyStrength().defaultEquivalence());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/* 313 */     this.valueEquivalence = ((Equivalence)Preconditions.checkNotNull(equivalence));
/* 314 */     return this;
/*     */   }
/*     */   
/*     */   Equivalence<Object> getValueEquivalence() {
/* 318 */     return (Equivalence)MoreObjects.firstNonNull(this.valueEquivalence, getValueStrength().defaultEquivalence());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 486 */     me.weigher = ((Weigher)Preconditions.checkNotNull(weigher));
/* 487 */     return me;
/*     */   }
/*     */   
...
/*     */   {
/* 500 */     return (Weigher)MoreObjects.firstNonNull(this.weigher, OneWeigher.INSTANCE);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 742 */     me.removalListener = ((RemovalListener)Preconditions.checkNotNull(listener));
/* 743 */     return me;
/*     */   }
/*     */   
/*     */ 
...
/*     */   {
/* 749 */     return (RemovalListener)MoreObjects.firstNonNull(this.removalListener, NullListener.INSTANCE);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 834 */     ToStringHelper s = MoreObjects.toStringHelper(this);
...
/* 848 */       l = this.expireAfterWriteNanos;s.add("expireAfterWrite", 22 + l + "ns");
/*     */     }
/* 850 */     if (this.expireAfterAccessNanos != -1L) {
/* 851 */       l = this.expireAfterAccessNanos;s.add("expireAfterAccess", 22 + l + "ns");
/*     */     }
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\guava\cache\CacheBuilder.class
