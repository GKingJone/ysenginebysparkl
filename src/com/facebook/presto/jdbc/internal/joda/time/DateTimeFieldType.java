...
/*     */     {
/* 444 */       super();
/* 445 */       this.iOrdinal = paramByte;
/* 446 */       this.iUnitType = paramDurationFieldType1;
/* 447 */       this.iRangeType = paramDurationFieldType2;
/*     */     }
/*     */     
...
/* 464 */         return true;
/*     */       }
/* 466 */       if ((paramObject instanceof StandardDateTimeFieldType)) {
/* 467 */         return this.iOrdinal == ((StandardDateTimeFieldType)paramObject).iOrdinal;
/*     */       }
/* 469 */       return false;
/*     */     }
/*     */     
...
/*     */     {
/* 480 */       paramChronology = DateTimeUtils.getChronology(paramChronology);
/*     */       
/* 482 */       switch (this.iOrdinal) {
/*     */       case 1: 
/* 484 */         return paramChronology.era();
/*     */       case 2: 
/* 486 */         return paramChronology.yearOfEra();
/*     */       case 3: 
/* 488 */         return paramChronology.centuryOfEra();
/*     */       case 4: 
/* 490 */         return paramChronology.yearOfCentury();
/*     */       case 5: 
/* 492 */         return paramChronology.year();
/*     */       case 6: 
/* 494 */         return paramChronology.dayOfYear();
/*     */       case 7: 
/* 496 */         return paramChronology.monthOfYear();
/*     */       case 8: 
/* 498 */         return paramChronology.dayOfMonth();
/*     */       case 9: 
/* 500 */         return paramChronology.weekyearOfCentury();
/*     */       case 10: 
/* 502 */         return paramChronology.weekyear();
/*     */       case 11: 
/* 504 */         return paramChronology.weekOfWeekyear();
/*     */       case 12: 
/* 506 */         return paramChronology.dayOfWeek();
/*     */       case 13: 
/* 508 */         return paramChronology.halfdayOfDay();
/*     */       case 14: 
/* 510 */         return paramChronology.hourOfHalfday();
/*     */       case 15: 
/* 512 */         return paramChronology.clockhourOfHalfday();
/*     */       case 16: 
/* 514 */         return paramChronology.clockhourOfDay();
/*     */       case 17: 
/* 516 */         return paramChronology.hourOfDay();
/*     */       case 18: 
/* 518 */         return paramChronology.minuteOfDay();
/*     */       case 19: 
/* 520 */         return paramChronology.minuteOfHour();
/*     */       case 20: 
/* 522 */         return paramChronology.secondOfDay();
/*     */       case 21: 
/* 524 */         return paramChronology.secondOfMinute();
/*     */       case 22: 
/* 526 */         return paramChronology.millisOfDay();
/*     */       case 23: 
/* 528 */         return paramChronology.millisOfSecond();
/*     */       }
/*     */       
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\joda\time\DateTimeFieldType.class
