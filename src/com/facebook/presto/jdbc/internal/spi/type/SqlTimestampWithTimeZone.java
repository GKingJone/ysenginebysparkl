...
/*    */ {
/* 29 */   private static final DateTimeFormatter formatter = DateTimeFormatter.ofPattern("uuuu-MM-dd HH:mm:ss.SSS VV");
/*    */   
...
/*    */   {
/* 36 */     this.millisUtc = DateTimeEncoding.unpackMillisUtc(timestampWithTimeZone);
/* 37 */     this.timeZoneKey = DateTimeEncoding.unpackZoneKey(timestampWithTimeZone);
/*    */   }
/*    */   
...
/* 75 */       return false;
/*    */     }
/* 77 */     SqlTimestampWithTimeZone other = (SqlTimestampWithTimeZone)obj;
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\spi\type\SqlTimestampWithTimeZone.class
