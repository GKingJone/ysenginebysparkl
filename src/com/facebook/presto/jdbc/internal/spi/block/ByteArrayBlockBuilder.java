...
/*     */ {
/*  30 */   private static final int INSTANCE_SIZE = ClassLayout.parseClass(ByteArrayBlockBuilder.class).instanceSize();
/*     */   
...
/*  45 */     this.values = new byte[expectedEntries];
...
/*     */     }
/*     */     
/*  58 */     this.values[this.positionCount] = ((byte)value);
/*     */     
/*  60 */     this.positionCount += 1;
/*  61 */     this.blockBuilderStatus.addBytes(2);
/*  62 */     return this;
/*     */   }
/*     */   
/*     */ 
...
/*  81 */     this.blockBuilderStatus.addBytes(2);
/*  82 */     return this;
/*     */   }
/*     */   
/*     */ 
/*     */   public Block build()
/*     */   {
/*  88 */     return new ByteArrayBlock(this.positionCount, this.valueIsNull, this.values);
/*     */   }
/*     */   
/*     */ 
...
/*  98 */     this.values = new byte[newSize];
/*     */     
...
/*     */   {
/* 122 */     return BlockUtil.intSaturatedCast(2L * this.positionCount);
/*     */   }
/*     */   
/*     */ 
...
/* 164 */     blockBuilder.writeByte(this.values[position]);
/*     */   }
/*     */   
/*     */ 
...
/* 171 */     return new ByteArrayBlock(1, new boolean[] { this.valueIsNull[position] }, new byte[] { this.values[position] });
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 181 */     byte[] newValues = new byte[positions.size()];
...
/*     */     }
/* 188 */     return new ByteArrayBlock(positions.size(), newValueIsNull, newValues);
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/* 196 */     return new ByteArrayBlock(positionOffset, length, this.valueIsNull, this.values);
/*     */   }
/*     */   
/*     */ 
...
/* 205 */     byte[] newValues = Arrays.copyOfRange(this.values, positionOffset, positionOffset + length);
/* 206 */     return new ByteArrayBlock(length, newValueIsNull, newValues);
/*     */   }
/*     */   
/*     */ 
/*     */   public BlockEncoding getEncoding()
/*     */   {
/* 212 */     return new ByteArrayBlockEncoding();
/*     */   }
/*     */   
/*     */ 
/*     */   public String toString()
/*     */   {
/* 218 */     StringBuilder sb = new StringBuilder("ByteArrayBlockBuilder{");
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\spi\block\ByteArrayBlockBuilder.class
