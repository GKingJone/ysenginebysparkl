...
/*     */ {
/*  30 */   private static final int INSTANCE_SIZE = ClassLayout.parseClass(IntArrayBlockBuilder.class).instanceSize();
/*     */   
...
/*  45 */     this.values = new int[expectedEntries];
...
/*  61 */     this.blockBuilderStatus.addBytes(5);
/*  62 */     return this;
/*     */   }
/*     */   
/*     */ 
...
/*  81 */     this.blockBuilderStatus.addBytes(5);
/*  82 */     return this;
/*     */   }
/*     */   
/*     */ 
/*     */   public Block build()
/*     */   {
/*  88 */     return new IntArrayBlock(this.positionCount, this.valueIsNull, this.values);
/*     */   }
/*     */   
/*     */ 
...
/*  98 */     this.values = new int[newSize];
/*     */     
...
/*     */   {
/* 122 */     return BlockUtil.intSaturatedCast(5L * this.positionCount);
/*     */   }
/*     */   
/*     */ 
...
/* 164 */     blockBuilder.writeInt(this.values[position]);
/*     */   }
/*     */   
/*     */ 
...
/* 171 */     return new IntArrayBlock(1, new boolean[] { this.valueIsNull[position] }, new int[] { this.values[position] });
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 181 */     int[] newValues = new int[positions.size()];
...
/*     */     }
/* 188 */     return new IntArrayBlock(positions.size(), newValueIsNull, newValues);
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/* 196 */     return new IntArrayBlock(positionOffset, length, this.valueIsNull, this.values);
/*     */   }
/*     */   
/*     */ 
...
/* 205 */     int[] newValues = Arrays.copyOfRange(this.values, positionOffset, positionOffset + length);
/* 206 */     return new IntArrayBlock(length, newValueIsNull, newValues);
/*     */   }
/*     */   
/*     */ 
/*     */   public BlockEncoding getEncoding()
/*     */   {
/* 212 */     return new IntArrayBlockEncoding();
/*     */   }
/*     */   
/*     */ 
/*     */   public String toString()
/*     */   {
/* 218 */     StringBuilder sb = new StringBuilder("IntArrayBlockBuilder{");
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\spi\block\IntArrayBlockBuilder.class
