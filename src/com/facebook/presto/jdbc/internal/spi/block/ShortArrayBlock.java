...
/*     */   implements Block
/*     */ {
/*  28 */   private static final int INSTANCE_SIZE = ClassLayout.parseClass(ShortArrayBlock.class).instanceSize();
/*     */   
...
/*     */     
/*  64 */     this.sizeInBytes = BlockUtil.intSaturatedCast(3L * positionCount);
...
/* 113 */     blockBuilder.writeShort(this.values[(position + this.arrayOffset)]);
/*     */   }
/*     */   
/*     */ 
...
/* 120 */     return new ShortArrayBlock(1, new boolean[] { this.valueIsNull[(position + this.arrayOffset)] }, new short[] { this.values[(position + this.arrayOffset)] });
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 130 */     short[] newValues = new short[positions.size()];
...
/*     */     }
/* 137 */     return new ShortArrayBlock(positions.size(), newValueIsNull, newValues);
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/* 145 */     return new ShortArrayBlock(positionOffset + this.arrayOffset, length, this.valueIsNull, this.values);
/*     */   }
/*     */   
/*     */ 
...
/* 155 */     short[] newValues = Arrays.copyOfRange(this.values, positionOffset, positionOffset + length);
/* 156 */     return new ShortArrayBlock(length, newValueIsNull, newValues);
/*     */   }
/*     */   
/*     */ 
/*     */   public BlockEncoding getEncoding()
/*     */   {
/* 162 */     return new ShortArrayBlockEncoding();
/*     */   }
/*     */   
/*     */ 
/*     */   public String toString()
/*     */   {
/* 168 */     StringBuilder sb = new StringBuilder("ShortArrayBlock{");
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\spi\block\ShortArrayBlock.class
