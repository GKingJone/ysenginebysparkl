...
/*     */   implements Block
/*     */ {
/*  28 */   private static final int INSTANCE_SIZE = ClassLayout.parseClass(ByteArrayBlock.class).instanceSize();
/*     */   
...
/*     */     
/*  64 */     this.sizeInBytes = BlockUtil.intSaturatedCast(2L * positionCount);
...
/* 113 */     blockBuilder.writeByte(this.values[(position + this.arrayOffset)]);
/*     */   }
/*     */   
/*     */ 
...
/* 120 */     return new ByteArrayBlock(1, new boolean[] { this.valueIsNull[(position + this.arrayOffset)] }, new byte[] { this.values[(position + this.arrayOffset)] });
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 130 */     byte[] newValues = new byte[positions.size()];
...
/*     */     }
/* 137 */     return new ByteArrayBlock(positions.size(), newValueIsNull, newValues);
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/* 145 */     return new ByteArrayBlock(positionOffset + this.arrayOffset, length, this.valueIsNull, this.values);
/*     */   }
/*     */   
/*     */ 
...
/* 155 */     byte[] newValues = Arrays.copyOfRange(this.values, positionOffset, positionOffset + length);
/* 156 */     return new ByteArrayBlock(length, newValueIsNull, newValues);
/*     */   }
/*     */   
/*     */ 
/*     */   public BlockEncoding getEncoding()
/*     */   {
/* 162 */     return new ByteArrayBlockEncoding();
/*     */   }
/*     */   
/*     */ 
/*     */   public String toString()
/*     */   {
/* 168 */     StringBuilder sb = new StringBuilder("ByteArrayBlock{");
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\spi\block\ByteArrayBlock.class
