...
/*     */     {
/* 305 */       int e = 0;
/* 306 */       for (Feature f : enabled) {
/* 307 */         e |= 1 << f.ordinal();
/*     */       }
/* 309 */       int d = 0;
/* 310 */       for (Feature f : disabled) {
/* 311 */         d |= 1 << f.ordinal();
/*     */       }
...
/*     */     public Value()
/*     */     {
/* 410 */       this("", Shape.ANY, "", "", Features.empty());
/*     */     }
/*     */     
/*     */     public Value(JsonFormat ann) {
/* 414 */       this(ann.pattern(), ann.shape(), ann.locale(), ann.timezone(), Features.construct(ann));
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 436 */       this._pattern = p;
/* 437 */       this._shape = (sh == null ? Shape.ANY : sh);
/* 438 */       this._locale = l;
/* 439 */       this._timezone = tz;
/* 440 */       this._timezoneStr = null;
/* 441 */       this._features = (f == null ? Features.empty() : f);
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 449 */       this._pattern = p;
/* 450 */       this._shape = (sh == null ? Shape.ANY : sh);
/* 451 */       this._locale = l;
/* 452 */       this._timezone = tz;
/* 453 */       this._timezoneStr = tzStr;
/* 454 */       this._features = (f == null ? Features.empty() : f);
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 462 */       this(p, sh, l, tz, Features.empty());
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 470 */       this(p, sh, localeStr, tzStr, Features.empty());
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 478 */       this(p, sh, l, tzStr, tz, Features.empty());
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 575 */       return new Value(p, null, null, null, null, Features.empty());
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 582 */       return new Value(null, sh, null, null, null, Features.empty());
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 617 */       Features newFeats = this._features.with(new Feature[] { f });
...
/*     */     {
/* 626 */       Features newFeats = this._features.without(new Feature[] { f });
...
/* 637 */     public Shape getShape() { return this._shape; }
...
/*     */     {
/* 669 */       return this._shape != Shape.ANY;
/*     */     }
/*     */     
/*     */ 
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\jackson\annotation\JsonFormat.class
