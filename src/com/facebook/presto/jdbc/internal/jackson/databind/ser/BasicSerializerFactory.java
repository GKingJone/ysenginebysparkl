...
/*      */ import com.facebook.presto.jdbc.internal.jackson.databind.ext.OptionalHandlerFactory;
...
/*      */ import com.facebook.presto.jdbc.internal.jackson.databind.introspect.BasicBeanDescription;
...
/*      */ import com.facebook.presto.jdbc.internal.jackson.databind.ser.std.BooleanSerializer;
/*      */ import com.facebook.presto.jdbc.internal.jackson.databind.ser.std.ByteBufferSerializer;
/*      */ import com.facebook.presto.jdbc.internal.jackson.databind.ser.std.CalendarSerializer;
/*      */ import com.facebook.presto.jdbc.internal.jackson.databind.ser.std.DateSerializer;
/*      */ import com.facebook.presto.jdbc.internal.jackson.databind.ser.std.JsonValueSerializer;
/*      */ import com.facebook.presto.jdbc.internal.jackson.databind.ser.std.MapSerializer;
/*      */ import com.facebook.presto.jdbc.internal.jackson.databind.ser.std.NumberSerializer;
...
/*      */ 
/*      */ 
/*   71 */     concrete.put(String.class.getName(), new com.facebook.presto.jdbc.internal.jackson.databind.ser.std.StringSerializer());
...
/*      */     
/*      */ 
/*   79 */     com.facebook.presto.jdbc.internal.jackson.databind.ser.std.NumberSerializers.addAll(concrete);
...
/*      */     
/*      */ 
/*   93 */     for (Map.Entry<Class<?>, Object> en : com.facebook.presto.jdbc.internal.jackson.databind.ser.std.StdJdkSerializers.all()) {
...
/*      */ 
/*      */ 
/*  108 */     concLazy.put(com.facebook.presto.jdbc.internal.jackson.databind.util.TokenBuffer.class.getName(), com.facebook.presto.jdbc.internal.jackson.databind.ser.std.TokenBufferSerializer.class);
/*      */     
...
/*  265 */     AnnotatedClass ac = bean.getClassInfo();
...
/*      */ 
/*      */ 
/*  271 */     java.util.Collection<com.facebook.presto.jdbc.internal.jackson.databind.jsontype.NamedType> subtypes = null;
/*  272 */     if (b == null) {
...
/*      */     
/*  346 */     if (com.facebook.presto.jdbc.internal.jackson.databind.JsonSerializable.class.isAssignableFrom(raw)) {
/*  347 */       return com.facebook.presto.jdbc.internal.jackson.databind.ser.std.SerializableSerializer.instance;
/*      */     }
/*      */     
...
/*  399 */       return new ByteBufferSerializer();
/*      */     }
/*  401 */     if (InetAddress.class.isAssignableFrom(raw)) {
/*  402 */       return new com.facebook.presto.jdbc.internal.jackson.databind.ser.std.InetAddressSerializer();
/*      */     }
/*  404 */     if (InetSocketAddress.class.isAssignableFrom(raw)) {
/*  405 */       return new com.facebook.presto.jdbc.internal.jackson.databind.ser.std.InetSocketAddressSerializer();
/*      */     }
/*  407 */     if (java.util.TimeZone.class.isAssignableFrom(raw)) {
/*  408 */       return new com.facebook.presto.jdbc.internal.jackson.databind.ser.std.TimeZoneSerializer();
/*      */     }
...
/*  513 */     return new com.facebook.presto.jdbc.internal.jackson.databind.ser.std.StdDelegatingSerializer(conv, delegateType, ser);
/*      */   }
/*      */   
/*      */ 
...
/*  667 */         if (EnumSet.class.isAssignableFrom(raw))
/*      */         {
...
/*  681 */                 ser = com.facebook.presto.jdbc.internal.jackson.databind.ser.impl.IndexedStringListSerializer.instance;
/*      */               }
/*      */             } else {
...
/*  690 */               ser = com.facebook.presto.jdbc.internal.jackson.databind.ser.impl.StringCollectionSerializer.instance;
/*      */             }
/*      */           }
/*  693 */           if (ser == null) {
...
/*      */   {
/*  722 */     return new com.facebook.presto.jdbc.internal.jackson.databind.ser.impl.IndexedListSerializer(elemType, staticTyping, vts, valueSerializer);
/*      */   }
/*      */   
...
/*  726 */     return new com.facebook.presto.jdbc.internal.jackson.databind.ser.std.CollectionSerializer(elemType, staticTyping, vts, valueSerializer);
/*      */   }
/*      */   
/*      */   public JsonSerializer<?> buildEnumSetSerializer(JavaType enumType) {
/*  730 */     return new com.facebook.presto.jdbc.internal.jackson.databind.ser.std.EnumSetSerializer(enumType);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  812 */       return null;
/*      */     }
/*  814 */     JsonInclude.Include incl = inclV.getContentInclusion();
/*  815 */     switch (incl) {
/*      */     case USE_DEFAULTS: 
/*  817 */       return null;
/*      */     case NON_DEFAULT: 
...
/*  869 */           ser = com.facebook.presto.jdbc.internal.jackson.databind.ser.impl.StringArraySerializer.instance;
/*      */         }
/*      */         else {
/*  872 */           ser = com.facebook.presto.jdbc.internal.jackson.databind.ser.std.StdArraySerializers.findStandardImpl(raw);
/*      */         }
/*      */       }
/*  875 */       if (ser == null) {
/*  876 */         ser = new com.facebook.presto.jdbc.internal.jackson.databind.ser.std.ObjectArraySerializer(type.getContentType(), staticTyping, elementTypeSerializer, elementValueSerializer);
/*      */       }
/*      */     }
/*      */     
/*      */ 
...
/*      */     throws JsonMappingException
/*      */   {
/*  903 */     return new com.facebook.presto.jdbc.internal.jackson.databind.ser.impl.IteratorSerializer(valueType, staticTyping, createTypeSerializer(config, valueType));
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws JsonMappingException
/*      */   {
/*  914 */     return new com.facebook.presto.jdbc.internal.jackson.databind.ser.std.IterableSerializer(valueType, staticTyping, createTypeSerializer(config, valueType));
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws JsonMappingException
/*      */   {
/*  925 */     return new com.facebook.presto.jdbc.internal.jackson.databind.ser.impl.MapEntrySerializer(valueType, keyType, valueType, staticTyping, createTypeSerializer(config, valueType), null);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  947 */     JsonSerializer<?> ser = com.facebook.presto.jdbc.internal.jackson.databind.ser.std.EnumSerializer.construct(enumClass, config, beanDesc, format);
/*      */     
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\jackson\databind\ser\BasicSerializerFactory.class
