...
/*     */       
/* 823 */       if (useBigDec) {
/* 824 */         int f = Feature.WRITE_BIGDECIMAL_AS_PLAIN.getMask();
/* 825 */         newFlags |= f;
/* 826 */         mask |= f;
/*     */       }
...
/*     */   {
/* 911 */     if (this._rootName != null) {
/* 912 */       return !this._rootName.isEmpty();
/*     */     }
/* 914 */     return isEnabled(SerializationFeature.WRAP_ROOT_VALUE);
/*     */   }
/*     */   
/*     */   public final boolean isEnabled(SerializationFeature f) {
/* 918 */     return (this._serFeatures & f.getMask()) != 0;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 929 */     int mask = f.getMask();
/* 930 */     if ((this._generatorFeaturesToChange & mask) != 0) {
/* 931 */       return (this._generatorFeatures & f.getMask()) != 0;
/*     */     }
/* 933 */     return factory.isEnabled(f);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 943 */     return (this._serFeatures & featureMask) == featureMask;
/*     */   }
/*     */   
/*     */   public final int getSerializationFeatures() {
/* 947 */     return this._serFeatures;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 957 */     return this._filterProvider;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 971 */     return this._defaultPrettyPrinter;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 986 */     return getClassIntrospector().forSerialization(this, type, this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 997 */     return "[SerializationConfig: flags=0x" + Integer.toHexString(this._serFeatures) + "]";
/*     */   }
/*     */ }


/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\jackson\databind\SerializationConfig.class
