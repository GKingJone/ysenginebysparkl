...
/*     */ import com.facebook.presto.jdbc.internal.jackson.databind.cfg.MapperConfigBase;
...
/*     */ import com.facebook.presto.jdbc.internal.jackson.databind.introspect.NopAnnotationIntrospector;
...
/*     */   {
/* 865 */     return this._problemHandlers;
/*     */   }
/*     */   
/*     */   public final JsonNodeFactory getNodeFactory() {
/* 869 */     return this._nodeFactory;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 886 */     return getClassIntrospector().forDeserialization(this, type, this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 895 */     return getClassIntrospector().forCreation(this, type, this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 903 */     return getClassIntrospector().forDeserializationWithBuilder(this, type, this);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 922 */     BeanDescription bean = introspectClassAnnotations(baseType.getRawClass());
/* 923 */     AnnotatedClass ac = bean.getClassInfo();
/* 924 */     TypeResolverBuilder<?> b = getAnnotationIntrospector().findTypeResolver(this, ac, baseType);
/*     */     
/*     */ 
/*     */ 
/*     */ 
/* 929 */     Collection<NamedType> subtypes = null;
/* 930 */     if (b == null) {
/* 931 */       b = getDefaultTyper(baseType);
/* 932 */       if (b == null) {
/* 933 */         return null;
/*     */       }
/*     */     } else {
/* 936 */       subtypes = getSubtypeResolver().collectAndResolveSubtypesByTypeId(this, ac);
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 951 */     return b.buildTypeDeserializer(this, baseType, subtypes);
/*     */   }
/*     */ }


/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\jackson\databind\DeserializationConfig.class
