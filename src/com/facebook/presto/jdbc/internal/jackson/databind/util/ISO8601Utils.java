...
/* 385 */       int resp = test1(250000, 3);
/* 386 */       long msecs = System.currentTimeMillis() - start;
/* 387 */       System.out.println("Pow (" + resp + ") -> " + msecs + " ms");
/*     */       
/* 389 */       start = System.currentTimeMillis();
/* 390 */       resp = test2(250000, 3);
/* 391 */       msecs = System.currentTimeMillis() - start;
/* 392 */       System.out.println("Iter (" + resp + ") -> " + msecs + " ms");
/*     */     }
/*     */   }
/*     */   
...
/*     */   {
/* 398 */     int resp = 3;
/* 399 */     for (;;) { reps--; if (reps < 0) break;
/* 400 */       resp = (int)Math.pow(10.0D, pow);
/*     */     }
/* 402 */     return resp;
/*     */   }
/*     */   
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\jackson\databind\util\ISO8601Utils.class
