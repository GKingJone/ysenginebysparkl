...
/*     */     
/*  51 */     for (Entry<String, JsonNode> entry : this._children.entrySet()) {
...
/*     */   }
/*     */   
/*  79 */   public com.facebook.presto.jdbc.internal.jackson.core.JsonToken asToken() { return com.facebook.presto.jdbc.internal.jackson.core.JsonToken.START_OBJECT; }
/*     */   
/*     */   public int size()
/*     */   {
...
/*     */     }
/*     */     
/* 176 */     for (Entry<String, JsonNode> entry : m1.entrySet()) {
...
/*     */   {
/* 194 */     for (Entry<String, JsonNode> entry : this._children.entrySet()) {
...
/*     */   {
/* 209 */     for (Entry<String, JsonNode> entry : this._children.entrySet()) {
...
/*     */   {
/* 225 */     for (Entry<String, JsonNode> entry : this._children.entrySet()) {
...
/*     */   {
/* 242 */     for (Entry<String, JsonNode> entry : this._children.entrySet()) {
...
/*     */   {
/* 257 */     for (Entry<String, JsonNode> entry : this._children.entrySet()) {
...
/*     */     throws IOException
/*     */   {
/* 286 */     boolean trimEmptyArray = (provider != null) && (!provider.isEnabled(com.facebook.presto.jdbc.internal.jackson.databind.SerializationFeature.WRITE_EMPTY_JSON_ARRAYS));
/*     */     
/* 288 */     g.writeStartObject(this);
/* 289 */     for (Entry<String, JsonNode> en : this._children.entrySet())
/*     */     {
/*     */ 
/*     */ 
/*     */ 
...
/*     */     throws IOException
/*     */   {
/* 315 */     boolean trimEmptyArray = (provider != null) && (!provider.isEnabled(com.facebook.presto.jdbc.internal.jackson.databind.SerializationFeature.WRITE_EMPTY_JSON_ARRAYS));
/*     */     
/* 317 */     typeSer.writeTypePrefixForObject(this, g);
/* 318 */     for (Entry<String, JsonNode> en : this._children.entrySet()) {
...
/*     */   {
/* 377 */     for (Entry<String, ? extends JsonNode> en : properties.entrySet()) {
...
/*     */ 
/*     */ 
/*     */   public ObjectNode putRawValue(String fieldName, com.facebook.presto.jdbc.internal.jackson.databind.util.RawValue raw)
/*     */   {
...
/* 838 */     sb.append("{");
/* 839 */     int count = 0;
/* 840 */     for (Entry<String, JsonNode> en : this._children.entrySet()) {
/* 841 */       if (count > 0) {
/* 842 */         sb.append(",");
/*     */       }
/* 844 */       count++;
