...
/*     */     implements com.facebook.presto.jdbc.internal.jackson.databind.deser.ContextualDeserializer
/*     */   {
...
/*     */         
/*     */ 
/* 162 */         if ((t == JsonToken.START_ARRAY) && (ctxt.isEnabled(DeserializationFeature.UNWRAP_SINGLE_VALUE_ARRAYS))) {
/* 163 */           p.nextToken();
...
/*     */       throws IOException
/*     */     {
/* 309 */       return new Timestamp(_parseDate(jp, ctxt).getTime());
/*     */     }
/*     */   }
/*     */ }


/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\jackson\databind\deser\std\DateDeserializers.class
