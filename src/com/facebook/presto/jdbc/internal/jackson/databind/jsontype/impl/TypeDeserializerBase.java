...
/*     */ import com.facebook.presto.jdbc.internal.jackson.databind.deser.std.NullifyingDeserializer;
...
/*     */ 
/*     */ 
/* 277 */     if ((idResolver instanceof TypeIdResolverBase)) {
/* 278 */       String extraDesc = ((TypeIdResolverBase)idResolver).getDescForKnownTypeIds();
/* 279 */       if (extraDesc == null) {
/* 280 */         extraDesc = "known type ids are not statically known";
/*     */       } else {
/* 282 */         extraDesc = "known type ids = " + extraDesc;
/*     */       }
/*     */     } else {
/* 285 */       extraDesc = null;
/*     */     }
/* 287 */     return ctxt.handleUnknownTypeId(this._baseType, typeId, idResolver, extraDesc);
/*     */   }
/*     */ }


/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\jackson\databind\jsontype\impl\TypeDeserializerBase.class
