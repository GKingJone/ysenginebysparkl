...
/*      */       case 1: 
/* 2080 */         if (c != 39) {
/* 2081 */           c = _decodeEscaped();
/*      */         }
/*      */         break;
/*      */       case 2: 
/* 2085 */         c = _decodeUtf8_2(c);
/* 2086 */         break;
/*      */       case 3: 
/* 2088 */         c = _decodeUtf8_3(c);
/* 2089 */         break;
/*      */       case 4: 
/* 2091 */         c = _decodeUtf8_4(c);
/*      */         
/* 2093 */         outBuf[(outPtr++)] = ((char)(0xD800 | c >> 10));
/* 2094 */         if (outPtr >= outBuf.length) {
/* 2095 */           outBuf = this._textBuffer.finishCurrentSegment();
/* 2096 */           outPtr = 0;
/*      */         }
/* 2098 */         c = 0xDC00 | c & 0x3FF;
/*      */         
/* 2100 */         break;
/*      */       default: 
/* 2102 */         if (c < 32) {
/* 2103 */           _throwUnquotedSpace(c, "string value");
/*      */         }
/*      */         
/* 2106 */         _reportInvalidChar(c);
/*      */       }
/*      */       
/* 2109 */       if (outPtr >= outBuf.length) {
/* 2110 */         outBuf = this._textBuffer.finishCurrentSegment();
/* 2111 */         outPtr = 0;
/*      */       }
/*      */       
/* 2114 */       outBuf[(outPtr++)] = ((char)c); }
/*      */     label248:
/* 2116 */     this._textBuffer.setCurrentLength(outPtr);
/*      */     
/* 2118 */     return JsonToken.VALUE_STRING;
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 2128 */     while (ch == 73) {
/* 2129 */       ch = this._inputData.readUnsignedByte();
/*      */       String match;
/* 2131 */       String match; if (ch == 78) {
/* 2132 */         match = neg ? "-INF" : "+INF";
/* 2133 */       } else { if (ch != 110) break;
/* 2134 */         match = neg ? "-Infinity" : "+Infinity";
/*      */       }
/*      */       
/*      */ 
/* 2138 */       _matchToken(match, 3);
/* 2139 */       if (isEnabled(JsonParser.Feature.ALLOW_NON_NUMERIC_NUMBERS)) {
/* 2140 */         return resetAsNaN(match, neg ? Double.NEGATIVE_INFINITY : Double.POSITIVE_INFINITY);
/*      */       }
/* 2142 */       _reportError("Non-standard token '" + match + "': enable JsonParser.Feature.ALLOW_NON_NUMERIC_NUMBERS to allow");
/*      */     }
/* 2144 */     reportUnexpectedNumberChar(ch, "expected digit (0-9) to follow minus sign, for valid numeric value");
/* 2145 */     return null;
/*      */   }
/*      */   
/*      */   protected final void _matchToken(String matchStr, int i) throws IOException
/*      */   {
/* 2150 */     int len = matchStr.length();
/*      */     do {
/* 2152 */       int ch = this._inputData.readUnsignedByte();
/* 2153 */       if (ch != matchStr.charAt(i)) {
/* 2154 */         _reportInvalidToken(ch, matchStr.substring(0, i));
/*      */       }
/* 2156 */       i++; } while (i < len);
/*      */     
/* 2158 */     int ch = this._inputData.readUnsignedByte();
/* 2159 */     if ((ch >= 48) && (ch != 93) && (ch != 125)) {
/* 2160 */       _checkMatchEnd(matchStr, i, ch);
/*      */     }
/* 2162 */     this._nextByte = ch;
/*      */   }
/*      */   
/*      */   private final void _checkMatchEnd(String matchStr, int i, int ch) throws IOException
/*      */   {
/* 2167 */     char c = (char)_decodeCharForError(ch);
/* 2168 */     if (Character.isJavaIdentifierPart(c)) {
/* 2169 */       _reportInvalidToken(c, matchStr.substring(0, i));
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*      */     throws IOException
/*      */   {
/* 2181 */     int i = this._nextByte;
/* 2182 */     if (i < 0) {
/* 2183 */       i = this._inputData.readUnsignedByte();
/*      */     } else {
/* 2185 */       this._nextByte = -1;
/*      */     }
/*      */     for (;;) {
/* 2188 */       if (i > 32) {
/* 2189 */         if ((i == 47) || (i == 35)) {
/* 2190 */           return _skipWSComment(i);
/*      */         }
/* 2192 */         return i;
/*      */       }
/*      */       
/*      */ 
/* 2196 */       if ((i == 13) || (i == 10)) {
/* 2197 */         this._currInputRow += 1;
/*      */       }
/*      */       
/* 2200 */       i = this._inputData.readUnsignedByte();
/*      */     }
/*      */   }
/*      */   
...
/*      */ 
/*      */       }
/* 2220 */       else if ((i == 13) || (i == 10)) {
/* 2221 */         this._currInputRow += 1;
/*      */       }
/*      */       
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/* 2229 */       i = this._inputData.readUnsignedByte();
/*      */     }
/*      */   }
/*      */   
...
/* 2236 */     if (i < 0) {
/* 2237 */       i = this._inputData.readUnsignedByte();
/*      */     } else {
/* 2239 */       this._nextByte = -1;
/*      */     }
/*      */     
/* 2242 */     if (i == 58) {
/* 2243 */       i = this._inputData.readUnsignedByte();
/* 2244 */       if (i > 32) {
/* 2245 */         if ((i == 47) || (i == 35)) {
/* 2246 */           return _skipColon2(i, true);
/*      */         }
/* 2248 */         return i;
/*      */       }
/* 2250 */       if ((i == 32) || (i == 9)) {
/* 2251 */         i = this._inputData.readUnsignedByte();
/* 2252 */         if (i > 32) {
/* 2253 */           if ((i == 47) || (i == 35)) {
/* 2254 */             return _skipColon2(i, true);
/*      */           }
/* 2256 */           return i;
/*      */         }
/*      */       }
/* 2259 */       return _skipColon2(i, true);
/*      */     }
/* 2261 */     if ((i == 32) || (i == 9)) {
/* 2262 */       i = this._inputData.readUnsignedByte();
/*      */     }
/* 2264 */     if (i == 58) {
/* 2265 */       i = this._inputData.readUnsignedByte();
/* 2266 */       if (i > 32) {
/* 2267 */         if ((i == 47) || (i == 35)) {
/* 2268 */           return _skipColon2(i, true);
/*      */         }
/* 2270 */         return i;
/*      */       }
/* 2272 */       if ((i == 32) || (i == 9)) {
/* 2273 */         i = this._inputData.readUnsignedByte();
/* 2274 */         if (i > 32) {
/* 2275 */           if ((i == 47) || (i == 35)) {
/* 2276 */             return _skipColon2(i, true);
/*      */           }
/* 2278 */           return i;
/*      */         }
/*      */       }
/* 2281 */       return _skipColon2(i, true);
/*      */     }
/* 2283 */     return _skipColon2(i, false);
/*      */   }
/*      */   
/*      */   private final int _skipColon2(int i, boolean gotColon) throws IOException
/*      */   {
/* 2288 */     for (;; i = this._inputData.readUnsignedByte()) {
/* 2289 */       if (i > 32) {
/* 2290 */         if (i == 47) {
/* 2291 */           _skipComment();
/*      */ 
...
/*      */             }
/* 2306 */             _reportUnexpectedChar(i, "was expecting a colon to separate field name and value");
/*      */           }
/* 2308 */           gotColon = true;
/*      */         }
/*      */         
/*      */       }
/* 2312 */       else if ((i == 13) || (i == 10)) {
/* 2313 */         this._currInputRow += 1;
/*      */       }
/*      */     }
/*      */   }
/*      */   
...
/*      */     throws IOException
/*      */   {
/* 2321 */     if (!isEnabled(JsonParser.Feature.ALLOW_COMMENTS)) {
/* 2322 */       _reportUnexpectedChar(47, "maybe a (non-standard) comment? (not recognized as one since Feature 'ALLOW_COMMENTS' not enabled for parser)");
/*      */     }
/* 2324 */     int c = this._inputData.readUnsignedByte();
/* 2325 */     if (c == 47) {
/* 2326 */       _skipLine();
/* 2327 */     } else if (c == 42) {
/* 2328 */       _skipCComment();
/*      */     } else {
/* 2330 */       _reportUnexpectedChar(c, "was expecting either '*' or '/' for a comment");
/*      */     }
/*      */   }
/*      */   
...
/*      */     throws IOException
/*      */   {
/* 2337 */     int[] codes = CharTypes.getInputCodeComment();
/* 2338 */     int i = this._inputData.readUnsignedByte();
/*      */     
/*      */ 
/*      */     for (;;)
/*      */     {
/* 2343 */       int code = codes[i];
/* 2344 */       if (code != 0) {
/* 2345 */         switch (code) {
/*      */         case 42: 
/* 2347 */           i = this._inputData.readUnsignedByte();
/* 2348 */           if (i != 47) continue;
/* 2349 */           return;
/*      */         
/*      */ 
/*      */         case 10: 
/*      */         case 13: 
/* 2354 */           this._currInputRow += 1;
/* 2355 */           break;
/*      */         case 2: 
/* 2357 */           _skipUtf8_2(i);
/* 2358 */           break;
...
/*      */         
/*      */         default: 
/* 2367 */           _reportInvalidChar(i);
/*      */         }
/*      */       } else {
/* 2370 */         i = this._inputData.readUnsignedByte();
/*      */       }
/*      */     }
/*      */   }
/*      */   
/*      */   private final boolean _skipYAMLComment() throws IOException {
/* 2376 */     if (!isEnabled(JsonParser.Feature.ALLOW_YAML_COMMENTS)) {
/* 2377 */       return false;
/*      */     }
/* 2379 */     _skipLine();
/* 2380 */     return true;
...
/*      */     throws IOException
/*      */   {
/* 2390 */     int[] codes = CharTypes.getInputCodeComment();
/*      */     for (;;) {
/* 2392 */       int i = this._inputData.readUnsignedByte();
/* 2393 */       int code = codes[i];
/* 2394 */       if (code != 0) {
/* 2395 */         switch (code) {
/*      */         case 10: 
/*      */         case 13: 
/* 2398 */           this._currInputRow += 1;
/* 2399 */           return;
/*      */         case 42: 
/*      */           break;
/*      */         case 2: 
...
/*      */   {
/* 2424 */     int c = this._inputData.readUnsignedByte();
/*      */     
/* 2426 */     switch (c)
/*      */     {
/*      */     case 98: 
...
/*      */     
/*      */     default: 
/* 2449 */       return _handleUnrecognizedCharacterEscape((char)_decodeCharForError(c));
/*      */     }
/*      */     
/*      */     
/* 2453 */     int value = 0;
/* 2454 */     for (int i = 0; i < 4; i++) {
/* 2455 */       int ch = this._inputData.readUnsignedByte();
/* 2456 */       int digit = CharTypes.charToHex(ch);
/* 2457 */       if (digit < 0) {
/* 2458 */         _reportUnexpectedChar(ch, "expected a hex-digit for character escape sequence");
/*      */       }
/* 2460 */       value = value << 4 | digit;
/*      */     }
/* 2462 */     return (char)value;
/*      */   }
/*      */   
/*      */   protected int _decodeCharForError(int firstByte) throws IOException
/*      */   {
/* 2467 */     int c = firstByte & 0xFF;
/* 2468 */     if (c > 127)
/*      */     {
/*      */       int needed;
/*      */       int needed;
/* 2472 */       if ((c & 0xE0) == 192) {
/* 2473 */         c &= 0x1F;
/* 2474 */         needed = 1; } else { int needed;
/* 2475 */         if ((c & 0xF0) == 224) {
/* 2476 */           c &= 0xF;
/* 2477 */           needed = 2; } else { int needed;
/* 2478 */           if ((c & 0xF8) == 240)
/*      */           {
/* 2480 */             c &= 0x7;
/* 2481 */             needed = 3;
/*      */           } else {
/* 2483 */             _reportInvalidInitial(c & 0xFF);
/* 2484 */             needed = 1;
/*      */           }
/*      */         } }
/* 2487 */       int d = this._inputData.readUnsignedByte();
/* 2488 */       if ((d & 0xC0) != 128) {
/* 2489 */         _reportInvalidOther(d & 0xFF);
/*      */       }
/* 2491 */       c = c << 6 | d & 0x3F;
/*      */       
/* 2493 */       if (needed > 1) {
/* 2494 */         d = this._inputData.readUnsignedByte();
/* 2495 */         if ((d & 0xC0) != 128) {
/* 2496 */           _reportInvalidOther(d & 0xFF);
/*      */         }
/* 2498 */         c = c << 6 | d & 0x3F;
/* 2499 */         if (needed > 2) {
/* 2500 */           d = this._inputData.readUnsignedByte();
/* 2501 */           if ((d & 0xC0) != 128) {
/* 2502 */             _reportInvalidOther(d & 0xFF);
/*      */           }
/* 2504 */           c = c << 6 | d & 0x3F;
/*      */         }
/*      */       }
...
/*      */     throws IOException
/*      */   {
/* 2519 */     int d = this._inputData.readUnsignedByte();
/* 2520 */     if ((d & 0xC0) != 128) {
/* 2521 */       _reportInvalidOther(d & 0xFF);
/*      */     }
/* 2523 */     return (c & 0x1F) << 6 | d & 0x3F;
/*      */   }
/*      */   
/*      */   private final int _decodeUtf8_3(int c1) throws IOException
/*      */   {
/* 2528 */     c1 &= 0xF;
/* 2529 */     int d = this._inputData.readUnsignedByte();
/* 2530 */     if ((d & 0xC0) != 128) {
/* 2531 */       _reportInvalidOther(d & 0xFF);
/*      */     }
/* 2533 */     int c = c1 << 6 | d & 0x3F;
...
/*      */     throws IOException
/*      */   {
/* 2548 */     int d = this._inputData.readUnsignedByte();
/* 2549 */     if ((d & 0xC0) != 128) {
/* 2550 */       _reportInvalidOther(d & 0xFF);
/*      */     }
/* 2552 */     c = (c & 0x7) << 6 | d & 0x3F;
/* 2553 */     d = this._inputData.readUnsignedByte();
/* 2554 */     if ((d & 0xC0) != 128) {
/* 2555 */       _reportInvalidOther(d & 0xFF);
/*      */     }
/* 2557 */     c = c << 6 | d & 0x3F;
/* 2558 */     d = this._inputData.readUnsignedByte();
/* 2559 */     if ((d & 0xC0) != 128) {
/* 2560 */       _reportInvalidOther(d & 0xFF);
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */ 
/* 2566 */     return (c << 6 | d & 0x3F) - 65536;
/*      */   }
/*      */   
/*      */   private final void _skipUtf8_2(int c) throws IOException
/*      */   {
/* 2571 */     c = this._inputData.readUnsignedByte();
/* 2572 */     if ((c & 0xC0) != 128) {
/* 2573 */       _reportInvalidOther(c & 0xFF);
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*      */     throws IOException
/*      */   {
/* 2583 */     c = this._inputData.readUnsignedByte();
/* 2584 */     if ((c & 0xC0) != 128) {
/* 2585 */       _reportInvalidOther(c & 0xFF);
/*      */     }
/* 2587 */     c = this._inputData.readUnsignedByte();
/* 2588 */     if ((c & 0xC0) != 128) {
/* 2589 */       _reportInvalidOther(c & 0xFF);
/*      */     }
/*      */   }
/*      */   
/*      */   private final void _skipUtf8_4(int c) throws IOException
/*      */   {
/* 2595 */     int d = this._inputData.readUnsignedByte();
/* 2596 */     if ((d & 0xC0) != 128) {
/* 2597 */       _reportInvalidOther(d & 0xFF);
/*      */     }
/* 2599 */     d = this._inputData.readUnsignedByte();
/* 2600 */     if ((d & 0xC0) != 128) {
/* 2601 */       _reportInvalidOther(d & 0xFF);
/*      */     }
/* 2603 */     d = this._inputData.readUnsignedByte();
/* 2604 */     if ((d & 0xC0) != 128) {
/* 2605 */       _reportInvalidOther(d & 0xFF);
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*      */     throws IOException
/*      */   {
/* 2617 */     _reportInvalidToken(ch, matchedPart, "'null', 'true', 'false' or NaN");
/*      */   }
/*      */   
/*      */   protected void _reportInvalidToken(int ch, String matchedPart, String msg)
/*      */     throws IOException
/*      */   {
/* 2623 */     StringBuilder sb = new StringBuilder(matchedPart);
/*      */     
/*      */ 
/*      */ 
/*      */ 
/*      */     for (;;)
/*      */     {
/* 2630 */       char c = (char)_decodeCharForError(ch);
/* 2631 */       if (!Character.isJavaIdentifierPart(c)) {
/*      */         break;
/*      */       }
/* 2634 */       sb.append(c);
/* 2635 */       ch = this._inputData.readUnsignedByte();
/*      */     }
/* 2637 */     _reportError("Unrecognized token '" + sb.toString() + "': was expecting " + msg);
/*      */   }
/*      */   
/*      */ 
...
/*      */   {
/* 2644 */     if (c < 32) {
/* 2645 */       _throwInvalidSpace(c);
/*      */     }
/* 2647 */     _reportInvalidInitial(c);
/*      */   }
/*      */   
/*      */   protected void _reportInvalidInitial(int mask)
/*      */     throws JsonParseException
/*      */   {
/* 2653 */     _reportError("Invalid UTF-8 start byte 0x" + Integer.toHexString(mask));
/*      */   }
/*      */   
/*      */   private void _reportInvalidOther(int mask)
/*      */     throws JsonParseException
/*      */   {
/* 2659 */     _reportError("Invalid UTF-8 middle byte 0x" + Integer.toHexString(mask));
/*      */   }
/*      */   
/*      */   private static int[] _growArrayBy(int[] arr, int more)
/*      */   {
/* 2664 */     if (arr == null) {
/* 2665 */       return new int[more];
/*      */     }
/* 2667 */     return Arrays.copyOf(arr, arr.length + more);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     throws IOException
/*      */   {
/* 2683 */     ByteArrayBuilder builder = _getByteArrayBuilder();
/*      */     
/*      */ 
/*      */ 
/*      */ 
/*      */     for (;;)
/*      */     {
/* 2690 */       int ch = this._inputData.readUnsignedByte();
/* 2691 */       if (ch > 32) {
/* 2692 */         int bits = b64variant.decodeBase64Char(ch);
/* 2693 */         if (bits < 0) {
/* 2694 */           if (ch == 34) {
/* 2695 */             return builder.toByteArray();
/*      */           }
/* 2697 */           bits = _decodeBase64Escape(b64variant, ch, 0);
/* 2698 */           if (bits < 0) {}
/*      */         }
/*      */         else
/*      */         {
/* 2702 */           int decodedData = bits;
/*      */           
/*      */ 
/* 2705 */           ch = this._inputData.readUnsignedByte();
/* 2706 */           bits = b64variant.decodeBase64Char(ch);
/* 2707 */           if (bits < 0) {
/* 2708 */             bits = _decodeBase64Escape(b64variant, ch, 1);
/*      */           }
/* 2710 */           decodedData = decodedData << 6 | bits;
/*      */           
/* 2712 */           ch = this._inputData.readUnsignedByte();
/* 2713 */           bits = b64variant.decodeBase64Char(ch);
/*      */           
/*      */ 
/* 2716 */           if (bits < 0) {
/* 2717 */             if (bits != -2)
/*      */             {
/* 2719 */               if ((ch == 34) && (!b64variant.usesPadding())) {
/* 2720 */                 decodedData >>= 4;
/* 2721 */                 builder.append(decodedData);
/* 2722 */                 return builder.toByteArray();
/*      */               }
/* 2724 */               bits = _decodeBase64Escape(b64variant, ch, 2);
/*      */             }
/* 2726 */             if (bits == -2) {
/* 2727 */               ch = this._inputData.readUnsignedByte();
/* 2728 */               if (!b64variant.usesPaddingChar(ch)) {
/* 2729 */                 throw reportInvalidBase64Char(b64variant, ch, 3, "expected padding character '" + b64variant.getPaddingChar() + "'");
/*      */               }
/*      */               
/* 2732 */               decodedData >>= 4;
/* 2733 */               builder.append(decodedData);
/* 2734 */               continue;
/*      */             }
/*      */           }
/*      */           
/* 2738 */           decodedData = decodedData << 6 | bits;
/*      */           
/* 2740 */           ch = this._inputData.readUnsignedByte();
/* 2741 */           bits = b64variant.decodeBase64Char(ch);
/* 2742 */           if (bits < 0) {
/* 2743 */             if (bits != -2)
/*      */             {
/* 2745 */               if ((ch == 34) && (!b64variant.usesPadding())) {
/* 2746 */                 decodedData >>= 2;
/* 2747 */                 builder.appendTwoBytes(decodedData);
/* 2748 */                 return builder.toByteArray();
/*      */               }
/* 2750 */               bits = _decodeBase64Escape(b64variant, ch, 3);
/*      */             }
/* 2752 */             if (bits == -2)
/*      */             {
/*      */ 
...
/*      */ 
/* 2759 */               decodedData >>= 2;
/* 2760 */               builder.appendTwoBytes(decodedData);
/* 2761 */               continue;
/*      */             }
/*      */           }
/*      */           
/* 2765 */           decodedData = decodedData << 6 | bits;
/* 2766 */           builder.appendThreeBytes(decodedData);
/*      */         }
/*      */       }
/*      */     }
/*      */   }
...
/*      */   {
/* 2778 */     Object src = this._ioContext.getSourceReference();
/* 2779 */     return new JsonLocation(src, -1L, -1L, this._tokenInputRow, -1);
/*      */   }
/*      */   
/*      */ 
/*      */   public JsonLocation getCurrentLocation()
/*      */   {
/* 2785 */     Object src = this._ioContext.getSourceReference();
/* 2786 */     return new JsonLocation(src, -1L, -1L, this._currInputRow, -1);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 2800 */     return bytes == 4 ? q : q | -1 << (bytes << 3);
/*      */   }
/*      */ }


/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\facebook\presto\jdbc\internal\jackson\core\json\UTF8DataInputJsonParser.class
