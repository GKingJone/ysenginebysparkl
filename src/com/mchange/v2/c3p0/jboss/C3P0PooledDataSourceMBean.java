...
public abstract interface C3P0PooledDataSourceMBean
{
  ...
  public abstract void setUnreturnedConnectionTimeout(int paramInt)
    throws NamingException;
  
  public abstract boolean isDebugUnreturnedConnectionStackTraces();
  
  public abstract void setDebugUnreturnedConnectionStackTraces(boolean paramBoolean)
    throws NamingException;
  
  public abstract String getConnectionCustomizerClassName();
  
  public abstract void setConnectionCustomizerClassName(String paramString)
    throws NamingException;
  
  public abstract int getMaxConnectionAge();
  
  public abstract void setMaxConnectionAge(int paramInt)
    throws NamingException;
  
  public abstract int getMaxIdleTimeExcessConnections();
  
  public abstract void setMaxIdleTimeExcessConnections(int paramInt)
    throws NamingException;
  
  public abstract int getMaxAdministrativeTaskTime();
  
  public abstract void setMaxAdministrativeTaskTime(int paramInt)
    throws NamingException;
...
/* Location:              E:\BaiduYunDownload\伊萨时期的一些代码\SparkEngine终极版\jars\YISAEngineBySpark2-4.0.6-SNAPSHOT-jar-with-dependencies.jar!\com\mchange\v2\c3p0\jboss\C3P0PooledDataSourceMBean.class
